//---------------------------------------------------------------------------
// Dutch Apple Keyboard Layout (WKL)
// Automatically generated from kbdprldu.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'2',           0x00,   {L'2',     L'@',     WCH_NONE, 0x20AC,   0x2122}},
    ...
    {VK_OEM_4,      0x00,   {L'-',     L'_',     WCH_NONE, 0x2013,   0x2014}},
    {VK_OEM_2,      0x00,   {L'=',     L'+',     WCH_NONE, 0x2260,   0x00B1}},      // +/-
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x0153,   0x0152}},      // oe, OE
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2211,   0x201E}},
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, WCH_DEAD, 0x2030}},
    ...
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x00CA}},      // E circumflex
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x00C1}},      // Yen, A acute
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, WCH_DEAD, 0x00CB}},      // E diaeresis
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, 0x00A8,   WCH_NONE}},    // Diaeresis
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, WCH_DEAD, 0x00C8}},      // E grave
    ...
    {VK_OEM_6,      0x00,   {L'[',     L'{',     WCH_NONE, 0x201C,   0x201D}},
    {VK_OEM_1,      0x00,   {L']',     L'}',     WCH_NONE, 0x2018,   0x2019}},
    ...
    {VK_OEM_PLUS,   0x00,   {L';',     L':',     WCH_NONE, 0x2026,   0x00DA}},      // U acute
    {VK_OEM_3,      0x00,   {L'\'',    L'"',     WCH_NONE, 0x00E6,   0x00C6}},      // ae, AE
    {VK_OEM_7,      CAPLOK, {0x00A7,   0x00B1,   WCH_NONE, WCH_NONE, WCH_NONE}},    // Section, +/-
    {VK_OEM_5,      0x00,   {L'\\',    L'|',     WCH_NONE, 0x00AB,   0x00BB}},      // <<, >>
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x03A9,   0x00DB}},      // U circumflex
    ...
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_DEAD, 0x02C6}},      // Circumflex
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'~',     WCH_NONE}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x02DC}},      // Micro, Small tilde
    {VK_OEM_COMMA,  0x00,   {L',',     L'<',     WCH_NONE, 0x2264,   0x00AF}},      // Macron
    {VK_OEM_PERIOD, 0x00,   {L'.',     L'>',     WCH_NONE, 0x2265,   0x02D8}},      // Breve
    {VK_OEM_MINUS,  0x00,   {L'/',     L'?',     WCH_NONE, 0x00F7,   0x00BF}},      // Division, Inv ?
    {VK_SPACE,      0x00,   {L' ',     L' ',     WCH_NONE, 0x00A0,   0x00A0}},      // Nbrk space, Nbrk space
    {VK_OEM_102,    0x00,   {L'`',     L'~',     WCH_NONE, WCH_DEAD, 0x0178}},      // Y diaeresis
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'`',     WCH_NONE}},
