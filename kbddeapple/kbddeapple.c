...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    {'1',           0x00,   {L'1',     L'!',     WCH_NONE, 0x00A1,   0x00AC}},
    {'2',           0x00,   {L'2',     L'"',     WCH_NONE, 0x201C,   0x201D}},
    {'3',           0x00,   {L'3',     0x00A7,   WCH_NONE, 0x00B6,   L'#'}},
    {'4',           0x00,   {L'4',     L'$',     WCH_NONE, 0x00A2,   0x00A3}},
    ...
    {'8',           0x00,   {L'8',     L'(',     WCH_NONE, L'{',     0x02DC}},
    {'9',           0x00,   {L'9',     L')',     WCH_NONE, L'}',     0x00B7}},
    {'0',           0x00,   {L'0',     L'=',     WCH_NONE, 0x2260,   0x00AF}},
    {VK_OEM_4,      0x00,   {0x00DF,   L'?',     WCH_NONE, 0x00BF,   0x02D9}},
    ...
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x00B8}},
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x02DD}},
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x03A9,   0x02C7}},
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, WCH_DEAD, 0x00C1}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, 0x00A8,   WCH_NONE}},
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, 0x2044,   0x00DB}},
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},
    {VK_OEM_1,      CAPLOK, {0x00FC,   0x00DC,   WCH_NONE, 0x2022,   0x00B0}},
    {VK_OEM_PLUS,   0x00,   {L'+',     L'*',     WCH_NONE, 0x00B1,   0x2225}},
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E5,   0x00C5}},
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x201A,   0x00CD}},
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0x2122}},
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0x00CF}},
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x00A9,   0x00CC}},
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x00AA,   0x00D3}},
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x00BA,   0x0131}},
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x2206,   0x02C6}},
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, L'@',     0xFB02}},
    {VK_OEM_3,      CAPLOK, {0x00F6,   0x00D6,   WCH_NONE, 0x0153,   0x0152}},
    {VK_OEM_7,      CAPLOK, {0x00E4,   0x00C4,   WCH_NONE, 0x00E6,   0x00C6}},
    {VK_OEM_5,      0x00,   {WCH_DEAD, 0x00B0,   WCH_NONE, 0x201E,   0x201C}},
    {VK__none_,     0x00,   {L'^',     WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE}},
    {VK_OEM_2,      0x00,   {L'#',     L'\'',    WCH_NONE, 0x2018,   0x2019}},
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x2021}},
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2248,   0x00D9}},
    ...
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x02D8}},
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x221E,   0x02DB}},
