...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    {'1',           0x00,   {L'1',     L'!',     WCH_NONE, 0x2225,   0x00A1}},
    {'2',           0x00,   {L'2',     L'"',     WCH_NONE, L'@',     0xFB01}},
    {'3',           0x00,   {L'3',     L'#',     WCH_NONE, 0x20AC,   0xFB02}},
    {'4',           0x00,   {L'4',     L'$',     WCH_NONE, 0x00A3,   0x00A2}},
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, 0x2030,   0x221E}},
    {'6',           0x00,   {L'6',     L'&',     WCH_NONE, 0x00B6,   0x2022}},
    {'7',           0x00,   {L'7',     L'/',     WCH_NONE, 0x00F7,   0x2044}},
    {'8',           0x00,   {L'8',     L'(',     WCH_NONE, L'[',     L'{'}},
    {'9',           0x00,   {L'9',     L')',     WCH_NONE, L']',     L'}'}},
    {'0',           0x00,   {L'0',     L'=',     WCH_NONE, 0x2260,   0x2248}},
    {VK_OEM_MINUS,  0x00,   {L'\'',    L'?',     WCH_NONE, 0x00A7,   0x00BF}},
    {VK_OEM_PLUS,   0x00,   {L'+',     L'*',     WCH_NONE, 0x00B1,   0x25CA}},
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x0153,   0x0152}},
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2211,   0x2211}},
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x00E6,   0x00C6}},
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x00AE}},
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2122,   0x2122}},
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x00A5}},
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, 0x2020,   0x2021}},
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, 0x0131,   0x02DA}},
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},
    {VK_OEM_4,      0x00,   {0x00BA,   0x00AA,   WCH_NONE, 0x00B0,   0x02DA}},
    {VK_OEM_6,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, WCH_DEAD, 0x02DD}},
    {VK__none_,     0x00,   {0x00B4,   L'`',     WCH_NONE, 0x00A8,   WCH_NONE}},
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E5,   0x00C5}},
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x00DF,   0x00DF}},
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0x2206}},
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0x0192}},
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x02D9,   0x02D9}},
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x02C7,   0x02C7}},
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x00AF,   0x00AF}},
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x201E,   0x201A}},
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, 0x2018,   0x2019}},
    {VK_OEM_1,      CAPLOK, {0x00E7,   0x00C7,   WCH_NONE, 0x00B8,   0x02DB}},
    {VK_OEM_7,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, WCH_DEAD, WCH_DEAD}},
    {VK__none_,     0x00,   {L'~',     L'^',     WCH_NONE, 0x02DC,   0x02C6}},
    {VK_OEM_3,      0x00,   {0x00A7,   0x00B1,   WCH_NONE, 0x00A7,   0x00B1}},
    {VK_OEM_5,      0x00,   {L'\\',    L'|',     WCH_NONE, 0x2039,   0x203A}},
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x03A9,   0x03A9}},
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x00AB,   0x00BB}},
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A9,   0x00A9}},
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x221A}},
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x222B}},
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, 0x00AC,   0x00AC}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x00B5}},
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x201C,   0x201D}},
    {VK_OEM_PERIOD, 0x00,   {L'.',     L':',     WCH_NONE, 0x2026,   0x00B7}},
...
static DEADKEY dead_keys[] = {
    ...
    DEADTRANS(L' ', 0x02DC, 0x02DC, 0x0000),
    DEADTRANS(L'e', 0x02C6, 0x00EA, 0x0000),
    DEADTRANS(L'u', 0x02C6, 0x00FB, 0x0000),
    DEADTRANS(L'i', 0x02C6, 0x00EE, 0x0000),
    DEADTRANS(L'o', 0x02C6, 0x00F4, 0x0000),
    DEADTRANS(L'a', 0x02C6, 0x00E2, 0x0000),
    DEADTRANS(L'E', 0x02C6, 0x00CA, 0x0000),
    DEADTRANS(L'U', 0x02C6, 0x00DB, 0x0000),
    DEADTRANS(L'I', 0x02C6, 0x00CE, 0x0000),
    DEADTRANS(L'O', 0x02C6, 0x00D4, 0x0000),
    DEADTRANS(L'A', 0x02C6, 0x00C2, 0x0000),
    DEADTRANS(L'c', 0x02C6, 0x0109, 0x0000),
    DEADTRANS(L'h', 0x02C6, 0x0125, 0x0000),
    DEADTRANS(L'j', 0x02C6, 0x0135, 0x0000),
    DEADTRANS(L'g', 0x02C6, 0x011D, 0x0000),
    DEADTRANS(L's', 0x02C6, 0x015D, 0x0000),
    DEADTRANS(L'w', 0x02C6, 0x0175, 0x0000),
    DEADTRANS(L'y', 0x02C6, 0x0177, 0x0000),
    DEADTRANS(L'C', 0x02C6, 0x0108, 0x0000),
    DEADTRANS(L'H', 0x02C6, 0x0124, 0x0000),
    DEADTRANS(L'J', 0x02C6, 0x0134, 0x0000),
    DEADTRANS(L'G', 0x02C6, 0x011C, 0x0000),
    DEADTRANS(L'S', 0x02C6, 0x015C, 0x0000),
    DEADTRANS(L'W', 0x02C6, 0x0174, 0x0000),
    DEADTRANS(L'Y', 0x02C6, 0x0176, 0x0000),
    DEADTRANS(L' ', 0x02C6, 0x02C6, 0x0000),
    {0, 0, 0}
};
