...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {VK_OEM_4,      CAPLOK,               {L')',     0x00B0,   WCH_NONE, L'}',     L']'}},
    {VK_OEM_PLUS,   CAPLOK,               {L'-',     L'_',     WCH_NONE, 0x2014,   0x2013}},
    {'A',           CAPLOK | CAPLOKALTGR, {L'a',     L'A',     WCH_NONE, 0x00E6,   0x00C6}},
    {'Z',           CAPLOK | CAPLOKALTGR, {L'z',     L'Z',     WCH_NONE, 0x00C2,   0x00C5}},
    {'E',           CAPLOK | CAPLOKALTGR, {L'e',     L'E',     WCH_NONE, 0x00EA,   0x00CA}},
    {'R',           CAPLOK,               {L'r',     L'R',     WCH_NONE, 0x00AE,   0x201A}},
    {'T',           CAPLOK | CAPLOKALTGR, {L't',     L'T',     WCH_NONE, 0x2020,   0x2122}},
    {'Y',           CAPLOK | CAPLOKALTGR, {L'y',     L'Y',     WCH_NONE, 0x00DA,   0x0178}},
    {'U',           CAPLOK | CAPLOKALTGR, {L'u',     L'U',     WCH_NONE, 0x00BA,   0x00AA}},
    {'I',           CAPLOK | CAPLOKALTGR, {L'i',     L'I',     WCH_NONE, 0x00EE,   0x00EF}},
    {'O',           CAPLOK | CAPLOKALTGR, {L'o',     L'O',     WCH_NONE, 0x0153,   0x0152}},
    {'P',           CAPLOK,               {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},
    {VK_OEM_6,      CAPLOK | CAPLOKALTGR, {WCH_DEAD, WCH_DEAD, WCH_NONE, 0x00F4,   0x00D4}},
    {VK__none_,     0x00,                 {L'^',     0x00A8,   WCH_NONE, WCH_NONE, WCH_NONE}},
    {VK_OEM_1,      CAPLOK,               {L'$',     L'*',     WCH_NONE, 0x20AC,   0x00A5}},
    {'Q',           CAPLOK | CAPLOKALTGR, {L'q',     L'Q',     WCH_NONE, 0x2021,   0x03A9}},
    {'S',           CAPLOK | CAPLOKALTGR, {L's',     L'S',     WCH_NONE, 0x00D2,   0x2211}},
    {'D',           CAPLOK | CAPLOKALTGR, {L'd',     L'D',     WCH_NONE, 0x2202,   0x2206}},
    {'F',           CAPLOK | CAPLOKALTGR, {L'f',     L'F',     WCH_NONE, 0x0192,   0x00B7}},
    {'G',           CAPLOK | CAPLOKALTGR, {L'g',     L'G',     WCH_NONE, 0xFB01,   0xFB02}},
    {'H',           CAPLOK | CAPLOKALTGR, {L'h',     L'H',     WCH_NONE, 0x00CC,   0x00CE}},
    {'J',           CAPLOK | CAPLOKALTGR, {L'j',     L'J',     WCH_NONE, 0x00CF,   0x00CD}},
    {'K',           CAPLOK | CAPLOKALTGR, {L'k',     L'K',     WCH_NONE, 0x00C8,   0x00CB}},
    {'L',           CAPLOK | CAPLOKALTGR, {L'l',     L'L',     WCH_NONE, 0x00AC,   L'|'}},
    {'M',           CAPLOK | CAPLOKALTGR, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x00D3}},
    {VK_OEM_3,      CAPLOK,               {0x00F9,   L'%',     WCH_NONE, 0x00D9,   0x2030}},
    {VK_OEM_7,      CAPLOK,               {L'@',     L'#',     WCH_NONE, 0x2022,   0x0178}},
    {VK_OEM_5,      CAPLOK,               {WCH_DEAD, 0x00A3,   WCH_NONE, L'@',     L'#'}},
    ...
    {'C',           CAPLOK | CAPLOKALTGR, {L'c',     L'C',     WCH_NONE, 0x00A9,   0x00A2}},
    {'V',           CAPLOK | CAPLOKALTGR, {L'v',     L'V',     WCH_NONE, 0x25CA,   0x221A}},
    {'B',           CAPLOK | CAPLOKALTGR, {L'b',     L'B',     WCH_NONE, 0x00DF,   0x222B}},
    {'N',           CAPLOK | CAPLOKALTGR, {L'n',     L'N',     WCH_NONE, WCH_DEAD, 0x0131}},
    ...
    {VK_OEM_2,      CAPLOK,               {L':',     L'/',     WCH_NONE, 0x00F7,   L'\\'}},
