//---------------------------------------------------------------------------
// English Japanese Apple Keyboard Layout (WKL)
// Automatically generated from kbdprlej.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'0',           0x00,   {L'0',     L'0',     WCH_NONE, 0x00BA,   0x201A}},
    ...
    {VK_OEM_7,      0x00,   {L':',     L'*',     WCH_NONE, 0x00E6,   0x00C6}},
    ...
    {VK_OEM_MINUS,  0x00,   {L'-',     L'=',     WCH_NONE, 0x2013,   0x2014}},
    {VK_OEM_PLUS,   0x00,   {L'^',     L'~',     WCH_NONE, 0x2260,   0x00B1}},
    {VK_OEM_3,      0x00,   {0x00A5,   L'|',     WCH_NONE, L'\\',    L'|'}},
    {VK_OEM_8,      0x00,   {WCH_NONE, L'_',     WCH_NONE, WCH_DEAD, L'`'}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'`',     WCH_NONE}},
...
static USHORT scancode_to_vk[] = {
    ...
    /* 77 */ VK__none_,
    /* 78 */ VK__none_,
    /* 79 */ VK_OEM_ATTN | KBDSPECIAL,
    /* 7A */ VK__none_,
    /* 7B */ VK__none_ | KBDSPECIAL,
    /* 7C */ VK_TAB,
    /* 7D */ VK_OEM_3,
    /* 7E */ 0x00C2,
    /* 7F */ VK_OEM_PA2,
