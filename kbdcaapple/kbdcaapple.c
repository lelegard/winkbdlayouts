...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    {'1',           0x00,   {L'1',     L'!',     WCH_NONE, 0x00A1,   0x2248}},
    {'2',           0x00,   {L'2',     L'@',     WCH_NONE, L'@',     0x0131}},
    {'3',           0x00,   {L'3',     L'#',     WCH_NONE, 0x00A3,   0x02C6}},
    {'4',           0x00,   {L'4',     L'$',     WCH_NONE, 0x20AC,   0x02DC}},
    ...
    {VK_OEM_MINUS,  0x00,   {L'-',     L'_',     WCH_NONE, L'|',     0x00BF}},
    {VK_OEM_PLUS,   0x00,   {L'=',     L'+',     WCH_NONE, 0x00AC,   0x2013}},
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x0153,   0x0152}},
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2211,   0x2030}},
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x2202,   0x00AF}},
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00B6,   0x00AE}},
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2122,   0x02D8}},
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x02DD}},
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, WCH_NONE, 0x02DB}},
    ...
    {VK__none_,     0x00,   {L'^',     0x00A8,   WCH_NONE, L'`',     WCH_NONE}},
    {VK_OEM_6,      CAPLOK, {0x00E7,   0x00C7,   WCH_NONE, L'~',     WCH_DEAD}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, L'~'}},
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E6,   0x00C6}},
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x00DF,   0x00A7}},
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x00AA,   0x02C7}},
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0xFB02}},
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x00A9,   0xFB01}},
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x02D9,   0x00B7}},
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x2206,   0x201A}},
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x02DA,   0x2044}},
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, WCH_NONE, 0x2026}},
    {VK_OEM_1,      0x00,   {L';',     L':',     WCH_NONE, 0x00B0,   WCH_DEAD}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, 0x00B4}},
    {VK_OEM_3,      CAPLOK, {0x00E8,   0x00C8,   WCH_NONE, L'\\',    0x2019}},
    {VK_OEM_7,      0x00,   {L'/',     L'\\',    WCH_NONE, L'|',     WCH_NONE}},
    {VK_OEM_5,      CAPLOK, {0x00E0,   0x00C0,   WCH_NONE, L'`',     WCH_DEAD}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, L'`'}},
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x00AB,   0x2039}},
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x00BB,   0x203A}},
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A2,   0x2020}},
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x2264}},
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_NONE, 0x2265}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x00BA}},
    {VK_OEM_COMMA,  0x00,   {L',',     L'\'',    WCH_NONE, L'<',     L'x'}},
    {VK_OEM_PERIOD, 0x00,   {L'.',     L'"',     WCH_NONE, L'>',     0x00F7}},
    {VK_OEM_2,      CAPLOK, {0x00E9,   0x00C9,   WCH_NONE, L'/',     0x2260}},
    {VK_SPACE,      0x00,   {L' ',     L' ',     WCH_NONE, 0x00A0,   0x00A0}},
    {VK_OEM_102,    CAPLOK, {0x00F9,   0x00D9,   WCH_NONE, L'\\',    0x03A9}},
