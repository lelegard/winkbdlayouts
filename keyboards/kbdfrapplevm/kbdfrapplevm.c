//---------------------------------------------------------------------------
// French Apple VM Keyboard Layout (WKL)
// Automatically generated from kbdprlfr.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {VK_OEM_PLUS,   0x00,        {L'-',               L'_',         WCH_NONE, UC_EM_DASH,            UC_EN_DASH}},
    ...
    {VK_OEM_8,      0x00,        {L'=',               L'+',         WCH_NONE, UC_NOT_EQUAL,          UC_PLUS_MINUS}},
