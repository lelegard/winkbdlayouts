//---------------------------------------------------------------------------
// Danish Apple VM Keyboard Layout (WKL)
// Automatically generated from kbdprlda.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 -----     ----      --------  --------------
    {'1',           0x00,   {L'1',     L'!',     WCH_NONE, 0x00A1,   0x00AF}},      // Inv !, Macron
    {'2',           0x00,   {L'2',     L'"',     WCH_NONE, 0x201C,   0x201D}},      // Left double quotation, Right double quotation
    {'3',           0x00,   {L'3',     L'#',     WCH_NONE, 0x00A7,   L'$'}},        // Section
    {'4',           0x00,   {L'4',     0x20AC,   WCH_NONE, 0x00A3,   0x00A2}},      // Pound, Cent
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, 0x221E,   0x2030}},      // Infinity, Per mille sign
    {'6',           0x00,   {L'6',     L'&',     WCH_NONE, 0x2122,   0x02DC}},      // Small tilde
    {'7',           0x00,   {L'7',     L'/',     WCH_NONE, 0x00B6,   L'\\'}},       // Pilcrow
    ...
    {VK_OEM_4,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, L'\'',    0x2044}},      // Fraction slash
    {VK__none_,     0x00,   {0x00B4,   L'`',     WCH_NONE, WCH_NONE, WCH_NONE}},    // Acute
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x00B0,   0x2022}},      // Degree, Bullet
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2211,   0x02DA}},      // N-ary summation
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x00E9,   0x00C9}},      // e acute, E acute
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x00C2}},      // Registered, A circumflex
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x2021}},      // Dagger, Double dagger
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x0178}},      // Yen, Y diaeresis
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, 0x00FC,   0x00DC}},      // u diaeresis, U diaeresis
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, L'|',     0x0131}},      // Dotless I
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x0153,   0x0152}},      // oe, OE
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},      // N-ary product
    {VK_OEM_6,      CAPLOK, {0x00E5,   0x00C5,   WCH_NONE, 0x2018,   0x2019}},      // a ring above, A ring above, Left single quotation, Right single quotation
    {VK_OEM_1,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, WCH_DEAD, L'^'}},
    {VK__none_,     0x00,   {0x00A8,   L'^',     WCH_NONE, L'~',     WCH_NONE}},    // Diaeresis
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00AA,   0x00CA}},      // Fem ord, E circumflex
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x00DF,   0x02C7}},      // sharp S, Caron
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0x02D8}},      // Partial differential, Breve
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0xFB01}},      // f HOOK, Ligature fi
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x00A9,   0x00C1}},      // Copyright, A acute
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x00AB,   0x00BB}},      // <<, >>
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x2039,   0x203A}},      // Single left-pointing angle quotation, Single right-pointing angle quotation
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x2206,   0x02DD}},      // Increment, Double acute
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, 0x00AC,   0xFB02}},      // Not, Ligature fl
    {VK_OEM_3,      CAPLOK, {0x00E6,   0x00C6,   WCH_NONE, 0x00E4,   0x00C4}},      // ae, AE, a diaeresis, A diaeresis
    {VK_OEM_7,      CAPLOK, {0x00F8,   0x00D8,   WCH_NONE, 0x00F6,   0x00D6}},      // o stroke, O stroke, o diaeresis, O diaeresis
    {VK_OEM_5,      0x00,   {L'$',     0x00A7,   WCH_NONE, 0x2225,   L'\''}},       // Section, Parallel to
    {VK_OEM_2,      0x00,   {L'\'',    L'*',     WCH_NONE, L'@',     0x00BA}},      // Masc ord
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x03A9,   0x00B8}},      // Cedilla
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2026,   0x02D9}},      // Horizontal ellipsis, Dot above
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00E7,   0x00C7}},      // c cedilla, C cedilla
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},      // Square root, Lozenge
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x00CB}},      // Integral, E diaeresis
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, 0x00F1,   0x00D1}},      // n tilde, N tilde
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x02DB}},      // Micro, Ogonek
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x201A,   0x201E}},      // Single low-9 quotation, Double low-9 quotation
    {VK_OEM_PERIOD, 0x00,   {L'.',     L':',     WCH_NONE, 0x00B7,   0x00F7}},      // Middle dot, Division
