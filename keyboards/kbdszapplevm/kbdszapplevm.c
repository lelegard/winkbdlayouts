//---------------------------------------------------------------------------
// Swiss French Apple VM Keyboard Layout (WKL)
// Automatically generated from kbdprlsz.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 -----     ----      --------  --------------
    {'1',           0x00,   {L'1',     L'+',     WCH_NONE, 0x00B1,   0x221E}},      // +/-, Infinity
    {'2',           0x00,   {L'2',     L'"',     WCH_NONE, 0x201C,   0x201D}},      // Left double quotation, Right double quotation
    {'3',           0x00,   {L'3',     L'*',     WCH_NONE, L'#',     0x2039}},      // Single left-pointing angle quotation
    {'4',           0x00,   {L'4',     0x00E7,   WCH_NONE, 0x00C7,   0x2044}},      // c cedilla, C cedilla, Fraction slash
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, L'[',     L'['}},
    {'6',           0x00,   {L'6',     L'&',     WCH_NONE, L']',     L']'}},
    {'7',           0x00,   {L'7',     L'/',     WCH_NONE, L'|',     L'\\'}},
    {'8',           0x00,   {L'8',     L'(',     WCH_NONE, L'{',     0x00D2}},      // O grave
    {'9',           0x00,   {L'9',     L')',     WCH_NONE, L'}',     0x00D4}},      // O circumflex
    {'0',           0x00,   {L'0',     L'=',     WCH_NONE, 0x2260,   0x00DA}},      // Not equal to, U acute
    ...
    {VK_OEM_1,      0x00,   {0x00E8,   0x00FC,   WCH_NONE, 0x00A7,   0x00FF}},      // e grave, u diaeresis, Section, y diaeresis
    ...
    {VK_OEM_7,      0x00,   {0x00E9,   0x00F6,   WCH_NONE, 0x00A2,   0x02D8}},      // e acute, o diaeresis, Cent, Breve
    {VK_OEM_5,      0x00,   {0x00E0,   0x00E4,   WCH_NONE, 0x00E6,   0x00C6}},      // a grave, a diaeresis, ae, AE
