...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                           -----               ----      -----                  -----------
    {'1',           0x00,   {L'1',               L'!',               WCH_NONE, UC_INV_EXCL,           UC_ALMOST_EQUAL}},
    {'2',           0x00,   {L'2',               L'@',               WCH_NONE, L'@',                  UC_LOWER_DOTLESS_I}},
    {'3',           0x00,   {L'3',               L'#',               WCH_NONE, UC_POUND,              UC_MODIFIER_CIRCUMFLEX}},
    {'4',           0x00,   {L'4',               L'$',               WCH_NONE, UC_EURO,               UC_SMALL_TILDE}},
    {'5',           0x00,   {L'5',               L'%',               WCH_NONE, UC_INFINITY,           0x2225}},
    {'6',           0x00,   {L'6',               L'?',               WCH_NONE, WCH_NONE,              UC_DAGGER}},
    {'7',           0x00,   {L'7',               L'&',               WCH_NONE, L'{',                  UC_D_DAGGER}},
    {'8',           0x00,   {L'8',               L'*',               WCH_NONE, L'}',                  UC_BULLET}},
    {'9',           0x00,   {L'9',               L'(',               WCH_NONE, L'[',                  UC_PLUS_MINUS}},
    {'0',           0x00,   {L'0',               L')',               WCH_NONE, L']',                  UC_EM_DASH}},
    {VK_OEM_MINUS,  0x00,   {L'-',               L'_',               WCH_NONE, L'|',                  UC_INV_QUESTION}},
    {VK_OEM_PLUS,   0x00,   {L'=',               L'+',               WCH_NONE, UC_NOT,                UC_EN_DASH}},
    {'Q',           CAPLOK, {L'q',               L'Q',               WCH_NONE, UC_LOWER_OE,           UC_UPPER_OE}},
    {'W',           CAPLOK, {L'w',               L'W',               WCH_NONE, UC_N_ARY_SUM,          UC_PER_MILLE}},
    {'E',           CAPLOK, {L'e',               L'E',               WCH_NONE, UC_PARTIAL_DIFF,       UC_MACRON}},
    {'R',           CAPLOK, {L'r',               L'R',               WCH_NONE, UC_PILCROW,            UC_REGISTERED}},
    {'T',           CAPLOK, {L't',               L'T',               WCH_NONE, UC_TRADE,              UC_BREVE}},
    {'Y',           CAPLOK, {L'y',               L'Y',               WCH_NONE, UC_YEN,                UC_DOUBLE_ACUTE}},
    {'U',           CAPLOK, {L'u',               L'U',               WCH_NONE, WCH_NONE,              UC_OGONEK}},
    {'I',           CAPLOK, {L'i',               L'I',               WCH_NONE, UC_LOWER_PI,           UC_N_ARY_PROD}},
    {'O',           CAPLOK, {L'o',               L'O',               WCH_NONE, UC_LOWER_O_STROKE,     UC_UPPER_O_STROKE}},
    {'P',           CAPLOK, {L'p',               L'P',               WCH_NONE, UC_D_LEFT_QUOT,        UC_D_RIGHT_QUOT}},
    {VK_OEM_4,      0x00,   {WCH_DEAD,           WCH_DEAD,           WCH_NONE, WCH_DEAD,              UC_D9_QUOT}},
    {VK__none_,     0x00,   {L'^',               UC_DIAERESIS,       WCH_NONE, L'`',                  WCH_NONE}},
    {VK_OEM_6,      CAPLOK, {UC_LOWER_C_CEDILLA, UC_UPPER_C_CEDILLA, WCH_NONE, L'~',                  WCH_DEAD}},
    {VK__none_,     0x00,   {WCH_NONE,           WCH_NONE,           WCH_NONE, WCH_NONE,              L'~'}},
    {'A',           CAPLOK, {L'a',               L'A',               WCH_NONE, UC_LOWER_AE,           UC_UPPER_AE}},
    {'S',           CAPLOK, {L's',               L'S',               WCH_NONE, UC_LOWER_SHARP_S,      UC_SECTION}},
    {'D',           CAPLOK, {L'd',               L'D',               WCH_NONE, UC_FORDINAL,           UC_CARON}},
    {'F',           CAPLOK, {L'f',               L'F',               WCH_NONE, UC_LATIN_SMALL_F_HOOK, UC_LOWER_FL}},
    {'G',           CAPLOK, {L'g',               L'G',               WCH_NONE, UC_COPYRIGHT,          UC_LOWER_FI}},
    {'H',           CAPLOK, {L'h',               L'H',               WCH_NONE, UC_DOT_ABOVE,          UC_MIDDOT}},
    {'J',           CAPLOK, {L'j',               L'J',               WCH_NONE, 0x2206,                UC_S9_QUOT}},
    {'K',           CAPLOK, {L'k',               L'K',               WCH_NONE, 0x02DA,                UC_FRACTION_SLASH}},
    {'L',           CAPLOK, {L'l',               L'L',               WCH_NONE, WCH_NONE,              UC_ELLIPSIS}},
    {VK_OEM_1,      0x00,   {L';',               L':',               WCH_NONE, UC_DEGREE,             WCH_DEAD}},
    {VK__none_,     0x00,   {WCH_NONE,           WCH_NONE,           WCH_NONE, WCH_NONE,              UC_ACUTE}},
    {VK_OEM_3,      CAPLOK, {UC_LOWER_E_GRAVE,   UC_UPPER_E_GRAVE,   WCH_NONE, L'\\',                 UC_S_RIGHT_QUOT}},
    {VK_OEM_7,      0x00,   {L'/',               L'\\',              WCH_NONE, L'|',                  WCH_NONE}},
    {VK_OEM_5,      CAPLOK, {UC_LOWER_A_GRAVE,   UC_UPPER_A_GRAVE,   WCH_NONE, L'`',                  WCH_DEAD}},
    {VK__none_,     0x00,   {WCH_NONE,           WCH_NONE,           WCH_NONE, WCH_NONE,              L'`'}},
    {'Z',           CAPLOK, {L'z',               L'Z',               WCH_NONE, UC_DA_LEFT_QUOT,       UC_SA_LEFT_QUOT}},
    {'X',           CAPLOK, {L'x',               L'X',               WCH_NONE, UC_DA_RIGHT_QUOT,      UC_SA_RIGHT_QUOT}},
    {'C',           CAPLOK, {L'c',               L'C',               WCH_NONE, UC_CENT,               UC_DAGGER}},
    {'V',           CAPLOK, {L'v',               L'V',               WCH_NONE, UC_SQUARE_ROOT,        UC_LOZENGE}},
    {'B',           CAPLOK, {L'b',               L'B',               WCH_NONE, UC_INTEGRAL,           UC_LESS_EQUAL}},
    {'N',           CAPLOK, {L'n',               L'N',               WCH_NONE, WCH_NONE,              UC_GREATER_EQUAL}},
    {'M',           CAPLOK, {L'm',               L'M',               WCH_NONE, UC_MICRO,              UC_MORDINAL}},
    {VK_OEM_COMMA,  0x00,   {L',',               L'\'',              WCH_NONE, L'<',                  L'x'}},
    {VK_OEM_PERIOD, 0x00,   {L'.',               L'"',               WCH_NONE, L'>',                  UC_DIVISION}},
    {VK_OEM_2,      CAPLOK, {UC_LOWER_E_ACUTE,   UC_UPPER_E_ACUTE,   WCH_NONE, L'/',                  UC_NOT_EQUAL}},
    {VK_SPACE,      0x00,   {L' ',               L' ',               WCH_NONE, UC_NBSP,               UC_NBSP}},
    {VK_OEM_102,    CAPLOK, {UC_LOWER_U_GRAVE,   UC_UPPER_U_GRAVE,   WCH_NONE, L'\\',                 UC_UPPER_OMEGA}},
