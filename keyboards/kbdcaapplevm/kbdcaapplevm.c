//---------------------------------------------------------------------------
// Canadian French Apple VM Keyboard Layout (WKL)
// Automatically generated from kbdprlca.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 -----     ----      --------  --------------
    {'1',           0x00,   {L'1',     L'!',     WCH_NONE, 0x00A1,   0x2248}},      // Inv !, Almost equal to
    {'2',           0x00,   {L'2',     L'@',     WCH_NONE, L'@',     0x0131}},      // Dotless I
    {'3',           0x00,   {L'3',     L'#',     WCH_NONE, 0x00A3,   0x02C6}},      // Pound, Circumflex
    {'4',           0x00,   {L'4',     L'$',     WCH_NONE, 0x20AC,   0x02DC}},      // Small tilde
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, 0x221E,   0x2225}},      // Infinity, Parallel to
    {'6',           0x00,   {L'6',     L'?',     WCH_NONE, WCH_NONE, 0x2020}},      // Dagger
    {'7',           0x00,   {L'7',     L'&',     WCH_NONE, L'{',     0x2021}},      // Double dagger
    {'8',           0x00,   {L'8',     L'*',     WCH_NONE, L'}',     0x2022}},      // Bullet
    {'9',           0x00,   {L'9',     L'(',     WCH_NONE, L'[',     0x00B1}},      // +/-
    {'0',           0x00,   {L'0',     L')',     WCH_NONE, L']',     0x2014}},      // Em dash
    {VK_OEM_MINUS,  0x00,   {L'-',     L'_',     WCH_NONE, L'|',     0x00BF}},      // Inv ?
    {VK_OEM_PLUS,   0x00,   {L'=',     L'+',     WCH_NONE, 0x00AC,   0x2013}},      // Not, En dash
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x0153,   0x0152}},      // oe, OE
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2211,   0x2030}},      // N-ary summation, Per mille sign
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x2202,   0x00AF}},      // Partial differential, Macron
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00B6,   0x00AE}},      // Pilcrow, Registered
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2122,   0x02D8}},      // Breve
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x02DD}},      // Yen, Double acute
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, WCH_NONE, 0x02DB}},      // Ogonek
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, 0x03C0,   0x220F}},      // N-ary product
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},      // o stroke, O stroke
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x201C,   0x201D}},      // Left double quotation, Right double quotation
    {VK_OEM_4,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, WCH_DEAD, 0x201E}},      // Double low-9 quotation
    {VK__none_,     0x00,   {L'^',     0x00A8,   WCH_NONE, L'`',     WCH_NONE}},    // Diaeresis
    {VK_OEM_6,      CAPLOK, {0x00E7,   0x00C7,   WCH_NONE, L'~',     WCH_DEAD}},    // c cedilla, C cedilla
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, L'~'}},
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E6,   0x00C6}},      // ae, AE
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x00DF,   0x00A7}},      // sharp S, Section
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x00AA,   0x02C7}},      // Fem ord, Caron
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0xFB02}},      // f HOOK, Ligature fl
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x00A9,   0xFB01}},      // Copyright, Ligature fi
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x02D9,   0x00B7}},      // Dot above, Middle dot
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x2206,   0x201A}},      // Increment, Single low-9 quotation
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x02DA,   0x2044}},      // Fraction slash
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, WCH_NONE, 0x2026}},      // Horizontal ellipsis
    {VK_OEM_1,      0x00,   {L';',     L':',     WCH_NONE, 0x00B0,   WCH_DEAD}},    // Degree
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, 0x00B4}},      // Acute
    {VK_OEM_3,      CAPLOK, {0x00E8,   0x00C8,   WCH_NONE, L'\\',    0x2019}},      // e grave, E grave, Right single quotation
    {VK_OEM_7,      0x00,   {L'/',     L'\\',    WCH_NONE, L'|',     WCH_NONE}},
    {VK_OEM_5,      CAPLOK, {0x00E0,   0x00C0,   WCH_NONE, L'`',     WCH_DEAD}},    // a grave, A grave
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, L'`'}},
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x00AB,   0x2039}},      // <<, Single left-pointing angle quotation
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x00BB,   0x203A}},      // >>, Single right-pointing angle quotation
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A2,   0x2020}},      // Cent, Dagger
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},      // Square root, Lozenge
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x2264}},      // Integral, Less-than or equal to
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_NONE, 0x2265}},      // Greater-than or equal to
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x00BA}},      // Micro, Masc ord
    {VK_OEM_COMMA,  0x00,   {L',',     L'\'',    WCH_NONE, L'<',     L'x'}},
    {VK_OEM_PERIOD, 0x00,   {L'.',     L'"',     WCH_NONE, L'>',     0x00F7}},      // Division
    {VK_OEM_2,      CAPLOK, {0x00E9,   0x00C9,   WCH_NONE, L'/',     0x2260}},      // e acute, E acute, Not equal to
    {VK_SPACE,      0x00,   {L' ',     L' ',     WCH_NONE, 0x00A0,   0x00A0}},      // Nbrk space, Nbrk space
    {VK_OEM_102,    CAPLOK, {0x00F9,   0x00D9,   WCH_NONE, L'\\',    0x03A9}},      // u grave, U grave
