...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'0',           0x00,   {L'0',     L'=',     WCH_NONE, 0x2248,   0x2260}},
    ...
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x2022,   0x00B0}},      // Degree
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x03A9,   0x02DD}},      // Double acute
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x00E9,   0x00C9}},      // e acute, E acute
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x221A}},      // Registered
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x2021}},
    ...
    {VK_OEM_5,      0x00,   {0x00A7,   0x00B0,   WCH_NONE, 0x00B6,   0x2022}},      // Section, Degree, Pilcrow
    {VK_OEM_2,      0x00,   {L'\'',    L'*',     WCH_NONE, 0x2122,   0x2019}},
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x00F7,   0x2044}},      // Division
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2248,   0x02C7}},      // Caron
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00E7,   0x00C7}},      // c cedilla, C cedilla
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x2039,   0x00AB}},      // <<
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x203A,   0x00BB}},      // >>
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, 0x2018,   0x201C}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x2019,   0x201D}},
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x201A,   0x201E}},
