...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {VK_OEM_4,      0x00,   {L'-',     L'_',     WCH_NONE, 0x2013,   0x2014}},      // En dash, Em dash
    {VK_OEM_2,      0x00,   {L'=',     L'+',     WCH_NONE, 0x2260,   0x00B1}},      // Not equal to, +/-
    ...
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, WCH_DEAD, 0x2030}},      // Per mille sign
    ...
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x00CA}},      // Dagger, E circumflex
    ...
    {VK_OEM_6,      0x00,   {L'[',     L'{',     WCH_NONE, 0x201C,   0x201D}},      // Left double quotation, Right double quotation
    {VK_OEM_1,      0x00,   {L']',     L'}',     WCH_NONE, 0x2018,   0x2019}},      // Left single quotation, Right single quotation
    ...
    {VK_OEM_PLUS,   0x00,   {L';',     L':',     WCH_NONE, 0x2026,   0x00DA}},      // Horizontal ellipsis, U acute
