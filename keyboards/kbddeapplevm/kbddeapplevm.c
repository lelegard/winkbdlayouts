...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                             -----                 ----      -----                  -----------
    {'1',           0x00,   {L'1',                 L'!',                 WCH_NONE, UC_INV_EXCL,           UC_NOT}},
    {'2',           0x00,   {L'2',                 L'"',                 WCH_NONE, UC_D_LEFT_QUOT,        UC_D_RIGHT_QUOT}},
    {'3',           0x00,   {L'3',                 UC_SECTION,           WCH_NONE, UC_PILCROW,            L'#'}},
    {'4',           0x00,   {L'4',                 L'$',                 WCH_NONE, UC_CENT,               UC_POUND}},
    {'5',           0x00,   {L'5',                 L'%',                 WCH_NONE, L'[',                  UC_LOWER_FI}},
    {'6',           0x00,   {L'6',                 L'&',                 WCH_NONE, L']',                  WCH_DEAD}},
    {VK__none_,     0x00,   {WCH_NONE,             WCH_NONE,             WCH_NONE, WCH_NONE,              L'^'}},
    {'7',           0x00,   {L'7',                 L'/',                 WCH_NONE, L'|',                  L'\\'}},
    {'8',           0x00,   {L'8',                 L'(',                 WCH_NONE, L'{',                  UC_SMALL_TILDE}},
    {'9',           0x00,   {L'9',                 L')',                 WCH_NONE, L'}',                  UC_MIDDOT}},
    {'0',           0x00,   {L'0',                 L'=',                 WCH_NONE, UC_NOT_EQUAL,          UC_MACRON}},
    {VK_OEM_4,      0x00,   {UC_LOWER_SHARP_S,     L'?',                 WCH_NONE, UC_INV_QUESTION,       UC_DOT_ABOVE}},
    {VK_OEM_6,      0x00,   {WCH_DEAD,             WCH_DEAD,             WCH_NONE, L'\'',                 0x02DA}},
    {VK__none_,     0x00,   {UC_ACUTE,             L'`',                 WCH_NONE, WCH_NONE,              WCH_NONE}},
    {'Q',           CAPLOK, {L'q',                 L'Q',                 WCH_NONE, UC_DA_LEFT_QUOT,       UC_DA_RIGHT_QUOT}},
    {'W',           CAPLOK, {L'w',                 L'W',                 WCH_NONE, UC_N_ARY_SUM,          UC_D9_QUOT}},
    {'E',           CAPLOK, {L'e',                 L'E',                 WCH_NONE, UC_EURO,               UC_PER_MILLE}},
    {'R',           CAPLOK, {L'r',                 L'R',                 WCH_NONE, UC_REGISTERED,         UC_CEDILLA}},
    {'T',           CAPLOK, {L't',                 L'T',                 WCH_NONE, UC_DAGGER,             UC_DOUBLE_ACUTE}},
    {'Z',           CAPLOK, {L'z',                 L'Z',                 WCH_NONE, UC_UPPER_OMEGA,        UC_CARON}},
    {'U',           CAPLOK, {L'u',                 L'U',                 WCH_NONE, WCH_DEAD,              UC_UPPER_A_ACUTE}},
    {VK__none_,     0x00,   {WCH_NONE,             WCH_NONE,             WCH_NONE, UC_DIAERESIS,          WCH_NONE}},
    {'I',           CAPLOK, {L'i',                 L'I',                 WCH_NONE, UC_FRACTION_SLASH,     UC_UPPER_U_CIRCUMFLEX}},
    {'O',           CAPLOK, {L'o',                 L'O',                 WCH_NONE, UC_LOWER_O_STROKE,     UC_UPPER_O_STROKE}},
    {'P',           CAPLOK, {L'p',                 L'P',                 WCH_NONE, UC_LOWER_PI,           UC_N_ARY_PROD}},
    {VK_OEM_1,      CAPLOK, {UC_LOWER_U_DIAERESIS, UC_UPPER_U_DIAERESIS, WCH_NONE, UC_BULLET,             UC_DEGREE}},
    {VK_OEM_PLUS,   0x00,   {L'+',                 L'*',                 WCH_NONE, UC_PLUS_MINUS,         0x2225}},
    {'A',           CAPLOK, {L'a',                 L'A',                 WCH_NONE, UC_LOWER_A_RING_ABOVE, UC_UPPER_A_RING_ABOVE}},
    {'S',           CAPLOK, {L's',                 L'S',                 WCH_NONE, UC_S9_QUOT,            UC_UPPER_I_ACUTE}},
    {'D',           CAPLOK, {L'd',                 L'D',                 WCH_NONE, UC_PARTIAL_DIFF,       UC_TRADE}},
    {'F',           CAPLOK, {L'f',                 L'F',                 WCH_NONE, UC_LATIN_SMALL_F_HOOK, UC_UPPER_I_DIAERESIS}},
    {'G',           CAPLOK, {L'g',                 L'G',                 WCH_NONE, UC_COPYRIGHT,          UC_UPPER_I_GRAVE}},
    {'H',           CAPLOK, {L'h',                 L'H',                 WCH_NONE, UC_FORDINAL,           UC_UPPER_O_ACUTE}},
    {'J',           CAPLOK, {L'j',                 L'J',                 WCH_NONE, UC_MORDINAL,           UC_LOWER_DOTLESS_I}},
    {'K',           CAPLOK, {L'k',                 L'K',                 WCH_NONE, 0x2206,                UC_MODIFIER_CIRCUMFLEX}},
    {'L',           CAPLOK, {L'l',                 L'L',                 WCH_NONE, L'@',                  UC_LOWER_FL}},
    {VK_OEM_3,      CAPLOK, {UC_LOWER_O_DIAERESIS, UC_UPPER_O_DIAERESIS, WCH_NONE, UC_LOWER_OE,           UC_UPPER_OE}},
    {VK_OEM_7,      CAPLOK, {UC_LOWER_A_DIAERESIS, UC_UPPER_A_DIAERESIS, WCH_NONE, UC_LOWER_AE,           UC_UPPER_AE}},
    {VK_OEM_5,      0x00,   {WCH_DEAD,             UC_DEGREE,            WCH_NONE, UC_D9_QUOT,            UC_D_LEFT_QUOT}},
    {VK__none_,     0x00,   {L'^',                 WCH_NONE,             WCH_NONE, WCH_NONE,              WCH_NONE}},
    {VK_OEM_2,      0x00,   {L'#',                 L'\'',                WCH_NONE, UC_S_LEFT_QUOT,        UC_S_RIGHT_QUOT}},
    {'Y',           CAPLOK, {L'y',                 L'Y',                 WCH_NONE, UC_YEN,                UC_D_DAGGER}},
    {'X',           CAPLOK, {L'x',                 L'X',                 WCH_NONE, UC_ALMOST_EQUAL,       UC_UPPER_U_GRAVE}},
    {'C',           CAPLOK, {L'c',                 L'C',                 WCH_NONE, UC_LOWER_C_CEDILLA,    UC_UPPER_C_CEDILLA}},
    {'V',           CAPLOK, {L'v',                 L'V',                 WCH_NONE, UC_SQUARE_ROOT,        UC_LOZENGE}},
    {'B',           CAPLOK, {L'b',                 L'B',                 WCH_NONE, UC_INTEGRAL,           UC_SA_LEFT_QUOT}},
    {'N',           CAPLOK, {L'n',                 L'N',                 WCH_NONE, WCH_DEAD,              UC_SA_RIGHT_QUOT}},
    {VK__none_,     0x00,   {WCH_NONE,             WCH_NONE,             WCH_NONE, L'~',                  WCH_NONE}},
    {'M',           CAPLOK, {L'm',                 L'M',                 WCH_NONE, UC_MICRO,              UC_BREVE}},
    {VK_OEM_COMMA,  0x00,   {L',',                 L';',                 WCH_NONE, UC_INFINITY,           UC_OGONEK}},
