//---------------------------------------------------------------------------
// German Apple VM Keyboard Layout (WKL)
// Automatically generated from kbdprlde.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 -----     ----      --------  --------------
    {'1',           0x00,   {L'1',     L'!',     WCH_NONE, 0x00A1,   0x00AC}},      // Inv !, Not
    {'2',           0x00,   {L'2',     L'"',     WCH_NONE, 0x201C,   0x201D}},      // Left double quotation, Right double quotation
    {'3',           0x00,   {L'3',     0x00A7,   WCH_NONE, 0x00B6,   L'#'}},        // Section, Pilcrow
    {'4',           0x00,   {L'4',     L'$',     WCH_NONE, 0x00A2,   0x00A3}},      // Cent, Pound
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, L'[',     0xFB01}},      // Ligature fi
    {'6',           0x00,   {L'6',     L'&',     WCH_NONE, L']',     WCH_DEAD}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, L'^'}},
    {'7',           0x00,   {L'7',     L'/',     WCH_NONE, L'|',     L'\\'}},
    {'8',           0x00,   {L'8',     L'(',     WCH_NONE, L'{',     0x02DC}},      // Small tilde
    {'9',           0x00,   {L'9',     L')',     WCH_NONE, L'}',     0x00B7}},      // Middle dot
    {'0',           0x00,   {L'0',     L'=',     WCH_NONE, 0x2260,   0x00AF}},      // Not equal to, Macron
    {VK_OEM_4,      0x00,   {0x00DF,   L'?',     WCH_NONE, 0x00BF,   0x02D9}},      // sharp S, Inv ?, Dot above
    {VK_OEM_6,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, L'\'',    0x02DA}},
    {VK__none_,     0x00,   {0x00B4,   L'`',     WCH_NONE, WCH_NONE, WCH_NONE}},    // Acute
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x00AB,   0x00BB}},      // <<, >>
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2211,   0x201E}},      // N-ary summation, Double low-9 quotation
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x20AC,   0x2030}},      // Per mille sign
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x00B8}},      // Registered, Cedilla
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x02DD}},      // Dagger, Double acute
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x03A9,   0x02C7}},      // Caron
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, WCH_DEAD, 0x00C1}},      // A acute
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, 0x00A8,   WCH_NONE}},    // Diaeresis
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, 0x2044,   0x00DB}},      // Fraction slash, U circumflex
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},      // o stroke, O stroke
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},      // N-ary product
    {VK_OEM_1,      CAPLOK, {0x00FC,   0x00DC,   WCH_NONE, 0x2022,   0x00B0}},      // u diaeresis, U diaeresis, Bullet, Degree
    {VK_OEM_PLUS,   0x00,   {L'+',     L'*',     WCH_NONE, 0x00B1,   0x2225}},      // +/-, Parallel to
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E5,   0x00C5}},      // a ring above, A ring above
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x201A,   0x00CD}},      // Single low-9 quotation, I acute
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0x2122}},      // Partial differential
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0x00CF}},      // f HOOK, I diaeresis
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x00A9,   0x00CC}},      // Copyright, I grave
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x00AA,   0x00D3}},      // Fem ord, O acute
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x00BA,   0x0131}},      // Masc ord, Dotless I
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x2206,   0x02C6}},      // Increment, Circumflex
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, L'@',     0xFB02}},      // Ligature fl
    {VK_OEM_3,      CAPLOK, {0x00F6,   0x00D6,   WCH_NONE, 0x0153,   0x0152}},      // o diaeresis, O diaeresis, oe, OE
    {VK_OEM_7,      CAPLOK, {0x00E4,   0x00C4,   WCH_NONE, 0x00E6,   0x00C6}},      // a diaeresis, A diaeresis, ae, AE
    {VK_OEM_5,      0x00,   {WCH_DEAD, 0x00B0,   WCH_NONE, 0x201E,   0x201C}},      // Degree, Double low-9 quotation, Left double quotation
    {VK__none_,     0x00,   {L'^',     WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE}},
    {VK_OEM_2,      0x00,   {L'#',     L'\'',    WCH_NONE, 0x2018,   0x2019}},      // Left single quotation, Right single quotation
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x2021}},      // Yen, Double dagger
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2248,   0x00D9}},      // Almost equal to, U grave
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00E7,   0x00C7}},      // c cedilla, C cedilla
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},      // Square root, Lozenge
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x2039}},      // Integral, Single left-pointing angle quotation
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_DEAD, 0x203A}},      // Single right-pointing angle quotation
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'~',     WCH_NONE}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x02D8}},      // Micro, Breve
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x221E,   0x02DB}},      // Infinity, Ogonek
