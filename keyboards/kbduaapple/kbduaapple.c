//---------------------------------------------------------------------------
// Ukrainian Apple Keyboard Layout (WKL)
// Automatically generated from kbdprlru.dll and then manually modified.
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'T',           CAPLOK,               {0x0435, 0x0415,    WCH_NONE, 0x0451,                0x0401}},
    {'Y',           CAPLOK,               {0x043D, 0x041D,    WCH_NONE, 0x045A,                0x040A}},
    {'U',           CAPLOK,               {0x0433, 0x0413,    WCH_NONE, 0x0491,                0x0490}},
    ...
    {VK_OEM_6,      CAPLOK | CAPLOKALTGR, {0x0457, 0x0407,    WCH_NONE, 0x044A,                0x042A}},
    {'A',           CAPLOK,               {0x0444, 0x0424,    WCH_NONE, UC_LATIN_SMALL_F_HOOK, 0x20B4}},
    {'S',           CAPLOK,               {0x0456, 0x0406,    WCH_NONE, 0x044B,                0x042B}},
    ...
    {'H',           CAPLOK,               {0x0440, 0x0420,    WCH_NONE, 0x007B,                0x007D}},
    ...
    {VK_OEM_7,      CAPLOK,               {0x0454, 0x0404,    WCH_NONE, 0x044D,                0x042D}},
    {VK_OEM_3,      0x00,                 {L'\\',  L'/',      WCH_NONE, UC_SECTION,            UC_PLUS_MINUS}},
    {VK_OEM_5,      CAPLOK,               {0x02BC, 0x20B4,    WCH_NONE, 0x0451,                0x0401}},
    ...
    {VK_OEM_102,    0x00,                 {0x0491, 0x490,     WCH_NONE, L']',                  L'['}},
