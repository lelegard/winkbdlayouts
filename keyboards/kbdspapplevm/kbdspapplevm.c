//---------------------------------------------------------------------------
// Spanish Apple VM Keyboard Layout (WKL)
// Automatically generated from kbdprlsp.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 -----     ----      --------  --------------
    {'1',           0x00,   {L'1',     L'!',     WCH_NONE, L'|',     0x0131}},      // Dotless I
    {'2',           0x00,   {L'2',     L'"',     WCH_NONE, L'@',     0x02DD}},      // Double acute
    {'3',           0x00,   {L'3',     0x00B7,   WCH_NONE, L'#',     0x2022}},      // Middle dot, Bullet
    {'4',           0x00,   {L'4',     L'$',     WCH_NONE, 0x00A2,   0x00A3}},      // Cent, Pound
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, 0x221E,   0x2030}},      // Infinity, Per mille sign
    {'6',           0x00,   {L'6',     L'&',     WCH_NONE, 0x00AC,   WCH_NONE}},    // Not
    {'7',           0x00,   {L'7',     L'/',     WCH_NONE, 0x00F7,   0x2044}},      // Division, Fraction slash
    {'8',           0x00,   {L'8',     L'(',     WCH_NONE, 0x201C,   0x2018}},      // Left double quotation, Left single quotation
    {'9',           0x00,   {L'9',     L')',     WCH_NONE, 0x201D,   0x2019}},      // Right double quotation, Right single quotation
    {'0',           0x00,   {L'0',     L'=',     WCH_NONE, 0x2260,   0x2248}},      // Not equal to, Almost equal to
    {VK_OEM_4,      0x00,   {L'\'',    L'?',     WCH_NONE, 0x00B4,   0x00B8}},      // Acute, Cedilla
    {VK_OEM_6,      0x00,   {0x00A1,   0x00BF,   WCH_NONE, 0x201A,   0x02DB}},      // Inv !, Inv ?, Single low-9 quotation, Ogonek
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x0153,   0x0152}},      // oe, OE
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x00E6,   0x00C6}},      // ae, AE
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x20AC,   0x20AC}},
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   WCH_NONE}},    // Registered
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x2021}},      // Dagger, Double dagger
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   WCH_NONE}},    // Yen
    ...
    {VK_OEM_1,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, L'[',     0x02C6}},      // Circumflex
    {VK__none_,     0x00,   {L'`',     L'^',     WCH_NONE, WCH_NONE, WCH_NONE}},
    {VK_OEM_PLUS,   0x00,   {L'+',     L'*',     WCH_NONE, L']',     0x00B1}},      // +/-
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E5,   0x00C5}},      // a ring above, A ring above
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x222B,   WCH_NONE}},    // Integral
    ...
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x2225,   0xFB02}},      // Parallel to, Ligature fl
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x2122,   WCH_NONE}},
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x00B6,   0x00AF}},      // Pilcrow, Macron
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x00A7,   0x02C7}},      // Section, Caron
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, WCH_NONE, 0x02D8}},      // Breve
    {VK_OEM_3,      CAPLOK, {0x00F1,   0x00D1,   WCH_NONE, WCH_DEAD, 0x02DC}},      // n tilde, N tilde, Small tilde
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'~',     WCH_NONE}},
    {VK_OEM_7,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, L'{',     0x00AB}},      // <<
    {VK__none_,     0x00,   {0x00B4,   0x00A8,   WCH_NONE, WCH_NONE, WCH_NONE}},    // Acute, Diaeresis
    {VK_OEM_5,      0x00,   {0x00BA,   0x00AA,   WCH_NONE, L'\\',    0x00B0}},      // Masc ord, Fem ord, Degree
    {VK_OEM_2,      CAPLOK, {0x00E7,   0x00C7,   WCH_NONE, L'}',     0x00BB}},      // c cedilla, C cedilla, >>
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x03A9,   0x2039}},      // Single left-pointing angle quotation
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2211,   0x203A}},      // N-ary summation, Single right-pointing angle quotation
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A9,   WCH_NONE}},    // Copyright
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},      // Square root, Lozenge
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x00DF,   WCH_NONE}},    // sharp S
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_NONE, 0x02D9}},      // Dot above
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x02DA}},      // Micro
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x201E,   WCH_NONE}},    // Double low-9 quotation
    {VK_OEM_PERIOD, 0x00,   {L'.',     L':',     WCH_NONE, 0x2026,   0x2026}},      // Horizontal ellipsis, Horizontal ellipsis
