...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                           -----               ----      -----                  -----------
    {'1',           0x00,   {L'1',               L'!',               WCH_NONE, L'|',                  UC_LOWER_DOTLESS_I}},
    {'2',           0x00,   {L'2',               L'"',               WCH_NONE, L'@',                  UC_DOUBLE_ACUTE}},
    {'3',           0x00,   {L'3',               UC_MIDDOT,          WCH_NONE, L'#',                  UC_BULLET}},
    {'4',           0x00,   {L'4',               L'$',               WCH_NONE, UC_CENT,               UC_POUND}},
    {'5',           0x00,   {L'5',               L'%',               WCH_NONE, UC_INFINITY,           UC_PER_MILLE}},
    {'6',           0x00,   {L'6',               L'&',               WCH_NONE, UC_NOT,                WCH_NONE}},
    {'7',           0x00,   {L'7',               L'/',               WCH_NONE, UC_DIVISION,           UC_FRACTION_SLASH}},
    {'8',           0x00,   {L'8',               L'(',               WCH_NONE, UC_D_LEFT_QUOT,        UC_S_LEFT_QUOT}},
    {'9',           0x00,   {L'9',               L')',               WCH_NONE, UC_D_RIGHT_QUOT,       UC_S_RIGHT_QUOT}},
    {'0',           0x00,   {L'0',               L'=',               WCH_NONE, UC_NOT_EQUAL,          UC_ALMOST_EQUAL}},
    {VK_OEM_4,      0x00,   {L'\'',              L'?',               WCH_NONE, UC_ACUTE,              UC_CEDILLA}},
    {VK_OEM_6,      0x00,   {UC_INV_EXCL,        UC_INV_QUESTION,    WCH_NONE, UC_S9_QUOT,            UC_OGONEK}},
    {'Q',           CAPLOK, {L'q',               L'Q',               WCH_NONE, UC_LOWER_OE,           UC_UPPER_OE}},
    {'W',           CAPLOK, {L'w',               L'W',               WCH_NONE, UC_LOWER_AE,           UC_UPPER_AE}},
    {'E',           CAPLOK, {L'e',               L'E',               WCH_NONE, UC_EURO,               UC_EURO}},
    {'R',           CAPLOK, {L'r',               L'R',               WCH_NONE, UC_REGISTERED,         WCH_NONE}},
    {'T',           CAPLOK, {L't',               L'T',               WCH_NONE, UC_DAGGER,             UC_D_DAGGER}},
    {'Y',           CAPLOK, {L'y',               L'Y',               WCH_NONE, UC_YEN,                WCH_NONE}},
    ...
    {VK_OEM_1,      0x00,   {WCH_DEAD,           WCH_DEAD,           WCH_NONE, L'[',                  UC_MODIFIER_CIRCUMFLEX}},
    {VK__none_,     0x00,   {L'`',               L'^',               WCH_NONE, WCH_NONE,              WCH_NONE}},
    {VK_OEM_PLUS,   0x00,   {L'+',               L'*',               WCH_NONE, L']',                  UC_PLUS_MINUS}},
    {'A',           CAPLOK, {L'a',               L'A',               WCH_NONE, UC_LOWER_A_RING_ABOVE, UC_UPPER_A_RING_ABOVE}},
    {'S',           CAPLOK, {L's',               L'S',               WCH_NONE, UC_INTEGRAL,           WCH_NONE}},
    {'D',           CAPLOK, {L'd',               L'D',               WCH_NONE, UC_PARTIAL_DIFF,       0x2206}},
    {'F',           CAPLOK, {L'f',               L'F',               WCH_NONE, UC_LATIN_SMALL_F_HOOK, UC_LOWER_FI}},
    {'G',           CAPLOK, {L'g',               L'G',               WCH_NONE, 0x2225,                UC_LOWER_FL}},
    {'H',           CAPLOK, {L'h',               L'H',               WCH_NONE, UC_TRADE,              WCH_NONE}},
    {'J',           CAPLOK, {L'j',               L'J',               WCH_NONE, UC_PILCROW,            UC_MACRON}},
    {'K',           CAPLOK, {L'k',               L'K',               WCH_NONE, UC_SECTION,            UC_CARON}},
    {'L',           CAPLOK, {L'l',               L'L',               WCH_NONE, WCH_NONE,              UC_BREVE}},
    {VK_OEM_3,      CAPLOK, {UC_LOWER_N_TILDE,   UC_UPPER_N_TILDE,   WCH_NONE, WCH_DEAD,              UC_SMALL_TILDE}},
    {VK__none_,     0x00,   {WCH_NONE,           WCH_NONE,           WCH_NONE, L'~',                  WCH_NONE}},
    {VK_OEM_7,      0x00,   {WCH_DEAD,           WCH_DEAD,           WCH_NONE, L'{',                  UC_DA_LEFT_QUOT}},
    {VK__none_,     0x00,   {UC_ACUTE,           UC_DIAERESIS,       WCH_NONE, WCH_NONE,              WCH_NONE}},
    {VK_OEM_5,      0x00,   {UC_MORDINAL,        UC_FORDINAL,        WCH_NONE, L'\\',                 UC_DEGREE}},
    {VK_OEM_2,      CAPLOK, {UC_LOWER_C_CEDILLA, UC_UPPER_C_CEDILLA, WCH_NONE, L'}',                  UC_DA_RIGHT_QUOT}},
    {'Z',           CAPLOK, {L'z',               L'Z',               WCH_NONE, UC_UPPER_OMEGA,        UC_SA_LEFT_QUOT}},
    {'X',           CAPLOK, {L'x',               L'X',               WCH_NONE, UC_N_ARY_SUM,          UC_SA_RIGHT_QUOT}},
    {'C',           CAPLOK, {L'c',               L'C',               WCH_NONE, UC_COPYRIGHT,          WCH_NONE}},
    {'V',           CAPLOK, {L'v',               L'V',               WCH_NONE, UC_SQUARE_ROOT,        UC_LOZENGE}},
    {'B',           CAPLOK, {L'b',               L'B',               WCH_NONE, UC_LOWER_SHARP_S,      WCH_NONE}},
    {'N',           CAPLOK, {L'n',               L'N',               WCH_NONE, WCH_NONE,              UC_DOT_ABOVE}},
    {'M',           CAPLOK, {L'm',               L'M',               WCH_NONE, UC_MICRO,              0x02DA}},
    {VK_OEM_COMMA,  0x00,   {L',',               L';',               WCH_NONE, UC_D9_QUOT,            WCH_NONE}},
    {VK_OEM_PERIOD, 0x00,   {L'.',               L':',               WCH_NONE, UC_ELLIPSIS,           UC_ELLIPSIS}},
