...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'0',           0x00,   {L'0',     L'0',     WCH_NONE, UC_MORDINAL,           UC_S9_QUOT}},
    ...
    {VK_OEM_7,      0x00,   {L':',     L'*',     WCH_NONE, UC_LOWER_AE,           UC_UPPER_AE}},
    ...
    {VK_OEM_MINUS,  0x00,   {L'-',     L'=',     WCH_NONE, UC_EN_DASH,            UC_EM_DASH}},
    {VK_OEM_PLUS,   0x00,   {L'^',     L'~',     WCH_NONE, UC_NOT_EQUAL,          UC_PLUS_MINUS}},
    {VK_OEM_3,      0x00,   {UC_YEN,   L'|',     WCH_NONE, L'\\',                 L'|'}},
