//---------------------------------------------------------------------------
// Italian Apple VM Keyboard Layout (WKL)
// Automatically generated from kbdprlit.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 -----     ----      --------  --------------
    {'1',           0x00,   {L'1',     L'!',     WCH_NONE, 0x00AB,   0x00BB}},      // <<, >>
    {'2',           0x00,   {L'2',     L'"',     WCH_NONE, 0x201C,   0x201D}},      // Left double quotation, Right double quotation
    {'3',           0x00,   {L'3',     0x00A3,   WCH_NONE, 0x2018,   0x2019}},      // Pound, Left single quotation, Right single quotation
    {'4',           0x00,   {L'4',     L'$',     WCH_NONE, 0x00A5,   0x00A2}},      // Yen, Cent
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, L'~',     0x2030}},      // Per mille sign
    {'6',           0x00,   {L'6',     L'&',     WCH_NONE, 0x2039,   0x203A}},      // Single left-pointing angle quotation, Single right-pointing angle quotation
    {'7',           0x00,   {L'7',     L'/',     WCH_NONE, 0x00F7,   0x2044}},      // Division, Fraction slash
    {'8',           0x00,   {L'8',     L'(',     WCH_NONE, WCH_DEAD, 0x2225}},      // Parallel to
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, 0x00B4,   WCH_NONE}},    // Acute
    {'9',           0x00,   {L'9',     L')',     WCH_NONE, WCH_DEAD, WCH_NONE}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'`',     WCH_NONE}},
    {'0',           0x00,   {L'0',     L'=',     WCH_NONE, 0x2260,   0x2248}},      // Not equal to, Almost equal to
    {VK_OEM_4,      0x00,   {L'\'',    L'?',     WCH_NONE, 0x00A1,   0x00BF}},      // Inv !, Inv ?
    {VK_OEM_6,      0x00,   {0x00EC,   L'^',     WCH_NONE, WCH_DEAD, 0x00B1}},      // i grave, +/-
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'^',     WCH_NONE}},
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x201E,   0x201A}},      // Double low-9 quotation, Single low-9 quotation
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x03A9,   0x00C0}},      // A grave
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x20AC,   0x00C8}},      // E grave
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x00CC}},      // Registered, I grave
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2122,   0x00D2}},      // O grave
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00E6,   0x00C6}},      // ae, AE
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, WCH_DEAD, 0x00D9}},      // U grave
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, 0x00A8,   WCH_NONE}},    // Diaeresis
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, 0x0153,   0x0152}},      // oe, OE
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},      // o stroke, O stroke
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},      // N-ary product
    {VK_OEM_1,      0x00,   {0x00E8,   0x00E9,   WCH_NONE, L'[',     L'{'}},        // e grave, e acute
    {VK_OEM_PLUS,   0x00,   {L'+',     L'*',     WCH_NONE, L']',     L'}'}},
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E5,   0x00C5}},      // a ring above, A ring above
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x00DF,   0x00AF}},      // sharp S, Macron
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0x02D8}},      // Partial differential, Breve
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0x02D9}},      // f HOOK, Dot above
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x221E,   0x02DA}},      // Infinity
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x2206,   0x00B8}},      // Increment, Cedilla
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x00AA,   0x02DD}},      // Fem ord, Double acute
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x00BA,   0x02DB}},      // Masc ord, Ogonek
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, 0x00AC,   0x02C7}},      // Not, Caron
    {VK_OEM_3,      0x00,   {0x00F2,   0x00E7,   WCH_NONE, L'@',     0x00C7}},      // o grave, c cedilla, C cedilla
    {VK_OEM_7,      0x00,   {0x00E0,   0x00B0,   WCH_NONE, L'#',     0x221E}},      // a grave, Degree, Infinity
    {VK_OEM_5,      0x00,   {L'\\',    L'|',     WCH_NONE, L'`',     0x0131}},      // Dotless I
    {VK_OEM_2,      0x00,   {0x00F9,   0x00A7,   WCH_NONE, 0x00B6,   0x25CA}},      // u grave, Section, Pilcrow, Lozenge
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x2211,   WCH_NONE}},    // N-ary summation
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2020,   0x2021}},      // Dagger, Double dagger
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A9,   0x00C1}},      // Copyright, A acute
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x00C9}},      // Square root, E acute
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x00CD}},      // Integral, I acute
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_DEAD, 0x00D3}},      // O acute
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'~',     WCH_NONE}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x00DA}},      // Micro, U acute
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x2026,   WCH_NONE}},    // Horizontal ellipsis
    {VK_OEM_PERIOD, 0x00,   {L'.',     L':',     WCH_NONE, 0x2022,   0x00B7}},      // Bullet, Middle dot
