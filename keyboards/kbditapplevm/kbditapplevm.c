...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                         -----               ----      -----                  -----------
    {'1',           0x00,   {L'1',             L'!',               WCH_NONE, UC_DA_LEFT_QUOT,       UC_DA_RIGHT_QUOT}},
    {'2',           0x00,   {L'2',             L'"',               WCH_NONE, UC_D_LEFT_QUOT,        UC_D_RIGHT_QUOT}},
    {'3',           0x00,   {L'3',             UC_POUND,           WCH_NONE, UC_S_LEFT_QUOT,        UC_S_RIGHT_QUOT}},
    {'4',           0x00,   {L'4',             L'$',               WCH_NONE, UC_YEN,                UC_CENT}},
    {'5',           0x00,   {L'5',             L'%',               WCH_NONE, L'~',                  UC_PER_MILLE}},
    {'6',           0x00,   {L'6',             L'&',               WCH_NONE, UC_SA_LEFT_QUOT,       UC_SA_RIGHT_QUOT}},
    {'7',           0x00,   {L'7',             L'/',               WCH_NONE, UC_DIVISION,           UC_FRACTION_SLASH}},
    {'8',           0x00,   {L'8',             L'(',               WCH_NONE, WCH_DEAD,              0x2225}},
    ...
    {VK_OEM_4,      0x00,   {L'\'',            L'?',               WCH_NONE, UC_INV_EXCL,           UC_INV_QUESTION}},
    {VK_OEM_6,      0x00,   {UC_LOWER_I_GRAVE, L'^',               WCH_NONE, WCH_DEAD,              UC_PLUS_MINUS}},
    {VK__none_,     0x00,   {WCH_NONE,         WCH_NONE,           WCH_NONE, L'^',                  WCH_NONE}},
    {'Q',           CAPLOK, {L'q',             L'Q',               WCH_NONE, UC_D9_QUOT,            UC_S9_QUOT}},
    {'W',           CAPLOK, {L'w',             L'W',               WCH_NONE, UC_UPPER_OMEGA,        UC_UPPER_A_GRAVE}},
    {'E',           CAPLOK, {L'e',             L'E',               WCH_NONE, UC_EURO,               UC_UPPER_E_GRAVE}},
    {'R',           CAPLOK, {L'r',             L'R',               WCH_NONE, UC_REGISTERED,         UC_UPPER_I_GRAVE}},
    {'T',           CAPLOK, {L't',             L'T',               WCH_NONE, UC_TRADE,              UC_UPPER_O_GRAVE}},
    {'Y',           CAPLOK, {L'y',             L'Y',               WCH_NONE, UC_LOWER_AE,           UC_UPPER_AE}},
    {'U',           CAPLOK, {L'u',             L'U',               WCH_NONE, WCH_DEAD,              UC_UPPER_U_GRAVE}},
    {VK__none_,     0x00,   {WCH_NONE,         WCH_NONE,           WCH_NONE, UC_DIAERESIS,          WCH_NONE}},
    {'I',           CAPLOK, {L'i',             L'I',               WCH_NONE, UC_LOWER_OE,           UC_UPPER_OE}},
    {'O',           CAPLOK, {L'o',             L'O',               WCH_NONE, UC_LOWER_O_STROKE,     UC_UPPER_O_STROKE}},
    {'P',           CAPLOK, {L'p',             L'P',               WCH_NONE, UC_LOWER_PI,           UC_N_ARY_PROD}},
    {VK_OEM_1,      0x00,   {UC_LOWER_E_GRAVE, UC_LOWER_E_ACUTE,   WCH_NONE, L'[',                  L'{'}},
    {VK_OEM_PLUS,   0x00,   {L'+',             L'*',               WCH_NONE, L']',                  L'}'}},
    {'A',           CAPLOK, {L'a',             L'A',               WCH_NONE, UC_LOWER_A_RING_ABOVE, UC_UPPER_A_RING_ABOVE}},
    {'S',           CAPLOK, {L's',             L'S',               WCH_NONE, UC_LOWER_SHARP_S,      UC_MACRON}},
    {'D',           CAPLOK, {L'd',             L'D',               WCH_NONE, UC_PARTIAL_DIFF,       UC_BREVE}},
    {'F',           CAPLOK, {L'f',             L'F',               WCH_NONE, UC_LATIN_SMALL_F_HOOK, UC_DOT_ABOVE}},
    {'G',           CAPLOK, {L'g',             L'G',               WCH_NONE, UC_INFINITY,           0x02DA}},
    {'H',           CAPLOK, {L'h',             L'H',               WCH_NONE, 0x2206,                UC_CEDILLA}},
    {'J',           CAPLOK, {L'j',             L'J',               WCH_NONE, UC_FORDINAL,           UC_DOUBLE_ACUTE}},
    {'K',           CAPLOK, {L'k',             L'K',               WCH_NONE, UC_MORDINAL,           UC_OGONEK}},
    {'L',           CAPLOK, {L'l',             L'L',               WCH_NONE, UC_NOT,                UC_CARON}},
    {VK_OEM_3,      0x00,   {UC_LOWER_O_GRAVE, UC_LOWER_C_CEDILLA, WCH_NONE, L'@',                  UC_UPPER_C_CEDILLA}},
    {VK_OEM_7,      0x00,   {UC_LOWER_A_GRAVE, UC_DEGREE,          WCH_NONE, L'#',                  UC_INFINITY}},
    {VK_OEM_5,      0x00,   {L'\\',            L'|',               WCH_NONE, L'`',                  UC_LOWER_DOTLESS_I}},
    {VK_OEM_2,      0x00,   {UC_LOWER_U_GRAVE, UC_SECTION,         WCH_NONE, UC_PILCROW,            UC_LOZENGE}},
    {'Z',           CAPLOK, {L'z',             L'Z',               WCH_NONE, UC_N_ARY_SUM,          WCH_NONE}},
    {'X',           CAPLOK, {L'x',             L'X',               WCH_NONE, UC_DAGGER,             UC_D_DAGGER}},
    {'C',           CAPLOK, {L'c',             L'C',               WCH_NONE, UC_COPYRIGHT,          UC_UPPER_A_ACUTE}},
    {'V',           CAPLOK, {L'v',             L'V',               WCH_NONE, UC_SQUARE_ROOT,        UC_UPPER_E_ACUTE}},
    {'B',           CAPLOK, {L'b',             L'B',               WCH_NONE, UC_INTEGRAL,           UC_UPPER_I_ACUTE}},
    {'N',           CAPLOK, {L'n',             L'N',               WCH_NONE, WCH_DEAD,              UC_UPPER_O_ACUTE}},
    {VK__none_,     0x00,   {WCH_NONE,         WCH_NONE,           WCH_NONE, L'~',                  WCH_NONE}},
    {'M',           CAPLOK, {L'm',             L'M',               WCH_NONE, UC_MICRO,              UC_UPPER_U_ACUTE}},
    {VK_OEM_COMMA,  0x00,   {L',',             L';',               WCH_NONE, UC_ELLIPSIS,           WCH_NONE}},
    {VK_OEM_PERIOD, 0x00,   {L'.',             L':',               WCH_NONE, UC_BULLET,             UC_MIDDOT}},
