...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'3',           0x00,   {L'3',     0x00A3,   WCH_NONE, 0x2018,   0x2019}},      // Pound
    {'4',           0x00,   {L'4',     L'$',     WCH_NONE, 0x00A5,   0x00A2}},      // Yen, Cent
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, L'~',     0x2030}},
    {'6',           0x00,   {L'6',     L'&',     WCH_NONE, 0x2039,   0x203A}},
    ...
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'^',     WCH_NONE}},
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x201E,   0x201A}},
    ...
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x221E,   0x02DA}},
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x2206,   0x00B8}},      // Cedilla
    ...
    {VK_OEM_7,      0x00,   {0x00E0,   0x00B0,   WCH_NONE, L'#',     0x221E}},      // a grave, Degree
    {VK_OEM_5,      0x00,   {L'\\',    L'|',     WCH_NONE, L'`',     0x0131}},      // Dotless I
    {VK_OEM_2,      0x00,   {0x00F9,   0x00A7,   WCH_NONE, 0x00B6,   0x25CA}},      // u grave, Section, Pilcrow
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x2211,   WCH_NONE}},
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2020,   0x2021}},
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A9,   0x00C1}},      // Copyright, A acute
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x00C9}},      // E acute
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x00CD}},      // I acute
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_DEAD, 0x00D3}},      // O acute
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'~',     WCH_NONE}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x00DA}},      // Micro, U acute
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x2026,   WCH_NONE}},
    {VK_OEM_PERIOD, 0x00,   {L'.',     L':',     WCH_NONE, 0x2022,   0x00B7}},      // Middle dot
