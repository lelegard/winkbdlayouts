...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {VK_OEM_PLUS,   CAPLOK,               {L'-',     L'_',     WCH_NONE, 0x2014,   0x2013}},
    ...
    {'T',           CAPLOK | CAPLOKALTGR, {L't',     L'T',     WCH_NONE, 0x2020,   0x2122}},
    ...
    {'Q',           CAPLOK | CAPLOKALTGR, {L'q',     L'Q',     WCH_NONE, 0x2021,   0x03A9}},
    {'S',           CAPLOK | CAPLOKALTGR, {L's',     L'S',     WCH_NONE, 0x00D2,   0x2211}},      // O grave
    {'D',           CAPLOK | CAPLOKALTGR, {L'd',     L'D',     WCH_NONE, 0x2202,   0x2206}},
    {'F',           CAPLOK | CAPLOKALTGR, {L'f',     L'F',     WCH_NONE, 0x0192,   0x00B7}},      // f HOOK, Middle dot
    {'G',           CAPLOK | CAPLOKALTGR, {L'g',     L'G',     WCH_NONE, 0xFB01,   0xFB02}},
    ...
    {VK_OEM_7,      CAPLOK,               {L'@',     L'#',     WCH_NONE, 0x2022,   0x0178}},      // Y diaeresis
    {VK_OEM_5,      CAPLOK,               {WCH_DEAD, 0x00A3,   WCH_NONE, L'@',     L'#'}},        // Pound
    {VK__none_,     0x00,                 {L'`',     WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE}},
    {'W',           CAPLOK | CAPLOKALTGR, {L'w',     L'W',     WCH_NONE, 0x2039,   0x203A}},
    {'X',           CAPLOK | CAPLOKALTGR, {L'x',     L'X',     WCH_NONE, 0x2248,   0x2044}},
    {'C',           CAPLOK | CAPLOKALTGR, {L'c',     L'C',     WCH_NONE, 0x00A9,   0x00A2}},      // Copyright, Cent
    {'V',           CAPLOK | CAPLOKALTGR, {L'v',     L'V',     WCH_NONE, 0x25CA,   0x221A}},
    {'B',           CAPLOK | CAPLOKALTGR, {L'b',     L'B',     WCH_NONE, 0x00DF,   0x222B}},      // sharp S
    ...
    {VK_OEM_PERIOD, CAPLOK,               {L';',     L'.',     WCH_NONE, 0x2026,   0x2022}},
    {VK_OEM_2,      CAPLOK,               {L':',     L'/',     WCH_NONE, 0x00F7,   L'\\'}},       // Division
    {VK_OEM_8,      CAPLOK,               {L'=',     L'+',     WCH_NONE, 0x2260,   0x00B1}},      // +/-
    {VK_SPACE,      0x00,                 {L' ',     L' ',     WCH_NONE, 0x00A0,   0x00A0}},      // Nbrk space, Nbrk space
    {VK_OEM_102,    CAPLOK,               {L'<',     L'>',     WCH_NONE, 0x2264,   0x2265}},
