//---------------------------------------------------------------------------
// United Kingdom Apple Keyboard Layout (WKL)
// Automatically generated from kbdprluk.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'3',           0x00,   {L'3',     0x00A3,   WCH_NONE, L'#',     0x2039}},      // Pound
    ...
    {VK_OEM_8,      0x00,   {0x00A7,   0x00B1,   WCH_NONE, WCH_NONE, WCH_NONE}},    // Section, +/-
    ...
    {VK_OEM_5,      0x00,   {L'`',     L'~',     WCH_NONE, WCH_DEAD, 0x0178}},      // Y diaeresis
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'`',     WCH_NONE}},
