...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                           -----               ----      -----                  -----------
    {'1',           0x00,   {L'1',               L'!',               WCH_NONE, 0x2225,                UC_INV_EXCL}},
    {'2',           0x00,   {L'2',               L'"',               WCH_NONE, L'@',                  UC_LOWER_FI}},
    {'3',           0x00,   {L'3',               L'#',               WCH_NONE, UC_EURO,               UC_LOWER_FL}},
    {'4',           0x00,   {L'4',               L'$',               WCH_NONE, UC_POUND,              UC_CENT}},
    {'5',           0x00,   {L'5',               L'%',               WCH_NONE, UC_PER_MILLE,          UC_INFINITY}},
    {'6',           0x00,   {L'6',               L'&',               WCH_NONE, UC_PILCROW,            UC_BULLET}},
    {'7',           0x00,   {L'7',               L'/',               WCH_NONE, UC_DIVISION,           UC_FRACTION_SLASH}},
    {'8',           0x00,   {L'8',               L'(',               WCH_NONE, L'[',                  L'{'}},
    {'9',           0x00,   {L'9',               L')',               WCH_NONE, L']',                  L'}'}},
    {'0',           0x00,   {L'0',               L'=',               WCH_NONE, UC_NOT_EQUAL,          UC_ALMOST_EQUAL}},
    {VK_OEM_MINUS,  0x00,   {L'\'',              L'?',               WCH_NONE, UC_SECTION,            UC_INV_QUESTION}},
    {VK_OEM_PLUS,   0x00,   {L'+',               L'*',               WCH_NONE, UC_PLUS_MINUS,         UC_LOZENGE}},
    {'Q',           CAPLOK, {L'q',               L'Q',               WCH_NONE, UC_LOWER_OE,           UC_UPPER_OE}},
    {'W',           CAPLOK, {L'w',               L'W',               WCH_NONE, UC_N_ARY_SUM,          UC_N_ARY_SUM}},
    {'E',           CAPLOK, {L'e',               L'E',               WCH_NONE, UC_LOWER_AE,           UC_UPPER_AE}},
    {'R',           CAPLOK, {L'r',               L'R',               WCH_NONE, UC_REGISTERED,         UC_REGISTERED}},
    {'T',           CAPLOK, {L't',               L'T',               WCH_NONE, UC_TRADE,              UC_TRADE}},
    {'Y',           CAPLOK, {L'y',               L'Y',               WCH_NONE, UC_YEN,                UC_YEN}},
    {'U',           CAPLOK, {L'u',               L'U',               WCH_NONE, UC_DAGGER,             UC_D_DAGGER}},
    {'I',           CAPLOK, {L'i',               L'I',               WCH_NONE, UC_LOWER_DOTLESS_I,    0x02DA}},
    {'O',           CAPLOK, {L'o',               L'O',               WCH_NONE, UC_LOWER_O_STROKE,     UC_UPPER_O_STROKE}},
    {'P',           CAPLOK, {L'p',               L'P',               WCH_NONE, UC_LOWER_PI,           UC_N_ARY_PROD}},
    {VK_OEM_4,      0x00,   {UC_MORDINAL,        UC_FORDINAL,        WCH_NONE, UC_DEGREE,             0x02DA}},
    {VK_OEM_6,      0x00,   {WCH_DEAD,           WCH_DEAD,           WCH_NONE, WCH_DEAD,              UC_DOUBLE_ACUTE}},
    {VK__none_,     0x00,   {UC_ACUTE,           L'`',               WCH_NONE, UC_DIAERESIS,          WCH_NONE}},
    {'A',           CAPLOK, {L'a',               L'A',               WCH_NONE, UC_LOWER_A_RING_ABOVE, UC_UPPER_A_RING_ABOVE}},
    {'S',           CAPLOK, {L's',               L'S',               WCH_NONE, UC_LOWER_SHARP_S,      UC_LOWER_SHARP_S}},
    {'D',           CAPLOK, {L'd',               L'D',               WCH_NONE, UC_PARTIAL_DIFF,       0x2206}},
    {'F',           CAPLOK, {L'f',               L'F',               WCH_NONE, UC_LATIN_SMALL_F_HOOK, UC_LATIN_SMALL_F_HOOK}},
    {'G',           CAPLOK, {L'g',               L'G',               WCH_NONE, UC_DOT_ABOVE,          UC_DOT_ABOVE}},
    {'H',           CAPLOK, {L'h',               L'H',               WCH_NONE, UC_CARON,              UC_CARON}},
    {'J',           CAPLOK, {L'j',               L'J',               WCH_NONE, UC_MACRON,             UC_MACRON}},
    {'K',           CAPLOK, {L'k',               L'K',               WCH_NONE, UC_D9_QUOT,            UC_S9_QUOT}},
    {'L',           CAPLOK, {L'l',               L'L',               WCH_NONE, UC_S_LEFT_QUOT,        UC_S_RIGHT_QUOT}},
    {VK_OEM_1,      CAPLOK, {UC_LOWER_C_CEDILLA, UC_UPPER_C_CEDILLA, WCH_NONE, UC_CEDILLA,            UC_OGONEK}},
    {VK_OEM_7,      0x00,   {WCH_DEAD,           WCH_DEAD,           WCH_NONE, WCH_DEAD,              WCH_DEAD}},
    {VK__none_,     0x00,   {L'~',               L'^',               WCH_NONE, UC_SMALL_TILDE,        UC_MODIFIER_CIRCUMFLEX}},
    {VK_OEM_3,      0x00,   {UC_SECTION,         UC_PLUS_MINUS,      WCH_NONE, UC_SECTION,            UC_PLUS_MINUS}},
    {VK_OEM_5,      0x00,   {L'\\',              L'|',               WCH_NONE, UC_SA_LEFT_QUOT,       UC_SA_RIGHT_QUOT}},
    {'Z',           CAPLOK, {L'z',               L'Z',               WCH_NONE, UC_UPPER_OMEGA,        UC_UPPER_OMEGA}},
    {'X',           CAPLOK, {L'x',               L'X',               WCH_NONE, UC_DA_LEFT_QUOT,       UC_DA_RIGHT_QUOT}},
    {'C',           CAPLOK, {L'c',               L'C',               WCH_NONE, UC_COPYRIGHT,          UC_COPYRIGHT}},
    {'V',           CAPLOK, {L'v',               L'V',               WCH_NONE, UC_SQUARE_ROOT,        UC_SQUARE_ROOT}},
    {'B',           CAPLOK, {L'b',               L'B',               WCH_NONE, UC_INTEGRAL,           UC_INTEGRAL}},
    {'N',           CAPLOK, {L'n',               L'N',               WCH_NONE, UC_NOT,                UC_NOT}},
    {'M',           CAPLOK, {L'm',               L'M',               WCH_NONE, UC_MICRO,              UC_MICRO}},
    {VK_OEM_COMMA,  0x00,   {L',',               L';',               WCH_NONE, UC_D_LEFT_QUOT,        UC_D_RIGHT_QUOT}},
    {VK_OEM_PERIOD, 0x00,   {L'.',               L':',               WCH_NONE, UC_ELLIPSIS,           UC_MIDDOT}},
    {VK_OEM_2,      0x00,   {L'-',               L'_',               WCH_NONE, UC_EM_DASH,            UC_EN_DASH}},
    {VK_SPACE,      0x00,   {L' ',               L' ',               WCH_NONE, UC_NBSP,               UC_NBSP}},
    {VK_OEM_102,    0x00,   {L'<',               L'>',               WCH_NONE, UC_LESS_EQUAL,         UC_GREATER_EQUAL}},
...
static DEADKEY dead_keys[] = {
    ...
    DEADTRANS(L' ', L'^',                   L'^',                   0x0000),
    DEADTRANS(L'n', UC_SMALL_TILDE,         UC_LOWER_N_TILDE,       0x0000),
    DEADTRANS(L'o', UC_SMALL_TILDE,         UC_LOWER_O_TILDE,       0x0000),
    DEADTRANS(L'a', UC_SMALL_TILDE,         UC_LOWER_A_TILDE,       0x0000),
    DEADTRANS(L'N', UC_SMALL_TILDE,         UC_UPPER_N_TILDE,       0x0000),
    DEADTRANS(L'O', UC_SMALL_TILDE,         UC_UPPER_O_TILDE,       0x0000),
    DEADTRANS(L'A', UC_SMALL_TILDE,         UC_UPPER_A_TILDE,       0x0000),
    DEADTRANS(L'u', UC_SMALL_TILDE,         UC_LOWER_U_TILDE,       0x0000),
    DEADTRANS(L'i', UC_SMALL_TILDE,         UC_LOWER_I_TILDE,       0x0000),
    DEADTRANS(L'U', UC_SMALL_TILDE,         UC_UPPER_U_TILDE,       0x0000),
    DEADTRANS(L'I', UC_SMALL_TILDE,         UC_UPPER_I_TILDE,       0x0000),
    DEADTRANS(L' ', UC_SMALL_TILDE,         UC_SMALL_TILDE,         0x0000),
    DEADTRANS(L'e', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_E_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'u', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_U_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'i', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_I_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'o', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_O_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'a', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_A_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'E', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_E_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'U', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_U_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'I', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_I_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'O', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_O_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'A', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_A_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'c', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_C_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'h', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_H_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'j', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_J_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'g', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_G_CIRCUMFLEX,  0x0000),
    DEADTRANS(L's', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_S_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'w', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_W_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'y', UC_MODIFIER_CIRCUMFLEX, UC_LOWER_Y_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'C', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_C_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'H', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_H_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'J', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_J_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'G', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_G_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'S', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_S_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'W', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_W_CIRCUMFLEX,  0x0000),
    DEADTRANS(L'Y', UC_MODIFIER_CIRCUMFLEX, UC_UPPER_Y_CIRCUMFLEX,  0x0000),
    DEADTRANS(L' ', UC_MODIFIER_CIRCUMFLEX, UC_MODIFIER_CIRCUMFLEX, 0x0000),
    {0, 0, 0}
};
