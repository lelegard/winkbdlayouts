...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, L'[',     0xFB01}},
    ...
    {'0',           0x00,   {L'0',     L'=',     WCH_NONE, 0x2260,   0x00AF}},      // Macron
    ...
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x20AC,   0x2030}},
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x00B8}},      // Registered, Cedilla
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x02DD}},      // Double acute
    ...
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, 0x2044,   0x00DB}},      // U circumflex
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},      // o stroke, O stroke
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},
    {VK_OEM_1,      CAPLOK, {0x00FC,   0x00DC,   WCH_NONE, 0x2022,   0x00B0}},      // u diaeresis, U diaeresis, Degree
    {VK_OEM_PLUS,   0x00,   {L'+',     L'*',     WCH_NONE, 0x00B1,   0x2225}},      // +/-
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E5,   0x00C5}},      // a ring above, A ring above
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x201A,   0x00CD}},      // I acute
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0x2122}},
    ...
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x2206,   0x02C6}},      // Circumflex
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, L'@',     0xFB02}},
    ...
    {VK_OEM_5,      0x00,   {WCH_DEAD, 0x00B0,   WCH_NONE, 0x201E,   0x201C}},      // Degree
    {VK__none_,     0x00,   {L'^',     WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE}},
    {VK_OEM_2,      0x00,   {L'#',     L'\'',    WCH_NONE, 0x2018,   0x2019}},
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x2021}},      // Yen
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2248,   0x00D9}},      // U grave
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00E7,   0x00C7}},      // c cedilla, C cedilla
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x2039}},
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_DEAD, 0x203A}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'~',     WCH_NONE}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x02D8}},      // Micro, Breve
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x221E,   0x02DB}},      // Ogonek
