//---------------------------------------------------------------------------
// Swiss German Apple VM Keyboard Layout (WKL)
// Automatically generated from kbdprlsg.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 -----     ----      --------  --------------
    {'1',           CAPLOK, {L'1',     L'+',     WCH_NONE, 0x00B1,   0x221E}},      // +/-, Infinity
    {'2',           CAPLOK, {L'2',     L'"',     WCH_NONE, 0x201C,   0x201D}},      // Left double quotation, Right double quotation
    {'3',           CAPLOK, {L'3',     L'*',     WCH_NONE, L'#',     0x2039}},      // Single left-pointing angle quotation
    {'4',           CAPLOK, {L'4',     0x00E7,   WCH_NONE, 0x00C7,   0x2044}},      // c cedilla, C cedilla, Fraction slash
    {'5',           CAPLOK, {L'5',     L'%',     WCH_NONE, L'[',     L'['}},
    {'6',           CAPLOK, {L'6',     L'&',     WCH_NONE, L']',     L']'}},
    {'7',           CAPLOK, {L'7',     L'/',     WCH_NONE, L'|',     L'\\'}},
    {'8',           CAPLOK, {L'8',     L'(',     WCH_NONE, L'{',     0x00D2}},      // O grave
    {'9',           CAPLOK, {L'9',     L')',     WCH_NONE, L'}',     0x00D4}},      // O circumflex
    {'0',           CAPLOK, {L'0',     L'=',     WCH_NONE, 0x2260,   0x00DA}},      // Not equal to, U acute
    {VK_OEM_4,      0x00,   {L'\'',    L'?',     WCH_NONE, 0x00BF,   0x2225}},      // Inv ?, Parallel to
    {VK_OEM_6,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, WCH_DEAD, L'^'}},
    {VK__none_,     0x00,   {L'^',     L'`',     WCH_NONE, 0x00B4,   WCH_NONE}},    // Acute
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x0153,   0x0152}},      // oe, OE
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2211,   0x00C1}},      // N-ary summation, A acute
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x20AC,   0x00CB}},      // E diaeresis
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x00C8}},      // Registered, E grave
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x00CE}},      // Dagger, I circumflex
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x03A9,   0x00CD}},      // I acute
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, 0x00B0,   0x00D9}},      // Degree, U grave
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, 0x00A1,   0x0131}},      // Inv !, Dotless I
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},      // o stroke, O stroke
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},      // N-ary product
    {VK_OEM_1,      CAPLOK, {0x00FC,   0x00E8,   WCH_NONE, 0x00A7,   0x00FF}},      // u diaeresis, e grave, Section, y diaeresis
    {VK_OEM_3,      0x00,   {WCH_DEAD, L'!',     WCH_NONE, 0x2018,   0x2019}},      // Left single quotation, Right single quotation
    {VK__none_,     0x00,   {0x00A8,   WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE}},    // Diaeresis
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E5,   0x00C5}},      // a ring above, A ring above
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x00DF,   0xFB01}},      // sharp S, Ligature fi
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0xFB02}},      // Partial differential, Ligature fl
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0x2021}},      // f HOOK, Double dagger
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, L'@',     0x201A}},      // Single low-9 quotation
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x00AA,   0x00B7}},      // Fem ord, Middle dot
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x00BA,   0x02DC}},      // Masc ord, Small tilde
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x2206,   0x00AF}},      // Increment, Macron
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, 0x00AC,   0x02C6}},      // Not, Circumflex
    {VK_OEM_7,      CAPLOK, {0x00F6,   0x00E9,   WCH_NONE, 0x00A2,   0x02D8}},      // o diaeresis, e acute, Cent, Breve
    {VK_OEM_5,      CAPLOK, {0x00E4,   0x00E0,   WCH_NONE, 0x00E6,   0x00C6}},      // a diaeresis, a grave, ae, AE
    {VK_OEM_2,      0x00,   {0x00A7,   0x00B0,   WCH_NONE, 0xFB01,   0x2030}},      // Section, Degree, Ligature fi, Per mille sign
    {VK_OEM_8,      0x00,   {L'$',     0x00A3,   WCH_NONE, 0x00B6,   0x2022}},      // Pound, Pilcrow, Bullet
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x0178}},      // Yen, Y diaeresis
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2248,   0x2122}},      // Almost equal to
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A9,   WCH_NONE}},    // Copyright
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},      // Square root, Lozenge
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   WCH_NONE}},    // Integral
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_DEAD, 0x02D9}},      // Dot above
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'~',     WCH_NONE}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x02DA}},      // Micro
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x00AB,   0x00BB}},      // <<, >>
    {VK_OEM_PERIOD, 0x00,   {L'.',     L':',     WCH_NONE, 0x2026,   0x00F7}},      // Horizontal ellipsis, Division
