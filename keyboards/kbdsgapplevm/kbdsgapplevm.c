...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                             -----               ----      -----                  -----------
    {'1',           CAPLOK, {L'1',                 L'+',               WCH_NONE, UC_PLUS_MINUS,         UC_INFINITY}},
    {'2',           CAPLOK, {L'2',                 L'"',               WCH_NONE, UC_D_LEFT_QUOT,        UC_D_RIGHT_QUOT}},
    {'3',           CAPLOK, {L'3',                 L'*',               WCH_NONE, L'#',                  UC_SA_LEFT_QUOT}},
    {'4',           CAPLOK, {L'4',                 UC_LOWER_C_CEDILLA, WCH_NONE, UC_UPPER_C_CEDILLA,    UC_FRACTION_SLASH}},
    {'5',           CAPLOK, {L'5',                 L'%',               WCH_NONE, L'[',                  L'['}},
    {'6',           CAPLOK, {L'6',                 L'&',               WCH_NONE, L']',                  L']'}},
    {'7',           CAPLOK, {L'7',                 L'/',               WCH_NONE, L'|',                  L'\\'}},
    {'8',           CAPLOK, {L'8',                 L'(',               WCH_NONE, L'{',                  UC_UPPER_O_GRAVE}},
    {'9',           CAPLOK, {L'9',                 L')',               WCH_NONE, L'}',                  UC_UPPER_O_CIRCUMFLEX}},
    {'0',           CAPLOK, {L'0',                 L'=',               WCH_NONE, UC_NOT_EQUAL,          UC_UPPER_U_ACUTE}},
    {VK_OEM_4,      0x00,   {L'\'',                L'?',               WCH_NONE, UC_INV_QUESTION,       0x2225}},
    {VK_OEM_6,      0x00,   {WCH_DEAD,             WCH_DEAD,           WCH_NONE, WCH_DEAD,              L'^'}},
    {VK__none_,     0x00,   {L'^',                 L'`',               WCH_NONE, UC_ACUTE,              WCH_NONE}},
    {'Q',           CAPLOK, {L'q',                 L'Q',               WCH_NONE, UC_LOWER_OE,           UC_UPPER_OE}},
    {'W',           CAPLOK, {L'w',                 L'W',               WCH_NONE, UC_N_ARY_SUM,          UC_UPPER_A_ACUTE}},
    {'E',           CAPLOK, {L'e',                 L'E',               WCH_NONE, UC_EURO,               UC_UPPER_E_DIAERESIS}},
    {'R',           CAPLOK, {L'r',                 L'R',               WCH_NONE, UC_REGISTERED,         UC_UPPER_E_GRAVE}},
    {'T',           CAPLOK, {L't',                 L'T',               WCH_NONE, UC_DAGGER,             UC_UPPER_I_CIRCUMFLEX}},
    {'Z',           CAPLOK, {L'z',                 L'Z',               WCH_NONE, UC_UPPER_OMEGA,        UC_UPPER_I_ACUTE}},
    {'U',           CAPLOK, {L'u',                 L'U',               WCH_NONE, UC_DEGREE,             UC_UPPER_U_GRAVE}},
    {'I',           CAPLOK, {L'i',                 L'I',               WCH_NONE, UC_INV_EXCL,           UC_LOWER_DOTLESS_I}},
    {'O',           CAPLOK, {L'o',                 L'O',               WCH_NONE, UC_LOWER_O_STROKE,     UC_UPPER_O_STROKE}},
    {'P',           CAPLOK, {L'p',                 L'P',               WCH_NONE, UC_LOWER_PI,           UC_N_ARY_PROD}},
    {VK_OEM_1,      CAPLOK, {UC_LOWER_U_DIAERESIS, UC_LOWER_E_GRAVE,   WCH_NONE, UC_SECTION,            UC_LOWER_Y_DIAERESIS}},
    {VK_OEM_3,      0x00,   {WCH_DEAD,             L'!',               WCH_NONE, UC_S_LEFT_QUOT,        UC_S_RIGHT_QUOT}},
    {VK__none_,     0x00,   {UC_DIAERESIS,         WCH_NONE,           WCH_NONE, WCH_NONE,              WCH_NONE}},
    {'A',           CAPLOK, {L'a',                 L'A',               WCH_NONE, UC_LOWER_A_RING_ABOVE, UC_UPPER_A_RING_ABOVE}},
    {'S',           CAPLOK, {L's',                 L'S',               WCH_NONE, UC_LOWER_SHARP_S,      UC_LOWER_FI}},
    {'D',           CAPLOK, {L'd',                 L'D',               WCH_NONE, UC_PARTIAL_DIFF,       UC_LOWER_FL}},
    {'F',           CAPLOK, {L'f',                 L'F',               WCH_NONE, UC_LATIN_SMALL_F_HOOK, UC_D_DAGGER}},
    {'G',           CAPLOK, {L'g',                 L'G',               WCH_NONE, L'@',                  UC_S9_QUOT}},
    {'H',           CAPLOK, {L'h',                 L'H',               WCH_NONE, UC_FORDINAL,           UC_MIDDOT}},
    {'J',           CAPLOK, {L'j',                 L'J',               WCH_NONE, UC_MORDINAL,           UC_SMALL_TILDE}},
    {'K',           CAPLOK, {L'k',                 L'K',               WCH_NONE, 0x2206,                UC_MACRON}},
    {'L',           CAPLOK, {L'l',                 L'L',               WCH_NONE, UC_NOT,                UC_MODIFIER_CIRCUMFLEX}},
    {VK_OEM_7,      CAPLOK, {UC_LOWER_O_DIAERESIS, UC_LOWER_E_ACUTE,   WCH_NONE, UC_CENT,               UC_BREVE}},
    {VK_OEM_5,      CAPLOK, {UC_LOWER_A_DIAERESIS, UC_LOWER_A_GRAVE,   WCH_NONE, UC_LOWER_AE,           UC_UPPER_AE}},
    {VK_OEM_2,      0x00,   {UC_SECTION,           UC_DEGREE,          WCH_NONE, UC_LOWER_FI,           UC_PER_MILLE}},
    {VK_OEM_8,      0x00,   {L'$',                 UC_POUND,           WCH_NONE, UC_PILCROW,            UC_BULLET}},
    {'Y',           CAPLOK, {L'y',                 L'Y',               WCH_NONE, UC_YEN,                UC_UPPER_Y_DIAERESIS}},
    {'X',           CAPLOK, {L'x',                 L'X',               WCH_NONE, UC_ALMOST_EQUAL,       UC_TRADE}},
    {'C',           CAPLOK, {L'c',                 L'C',               WCH_NONE, UC_COPYRIGHT,          WCH_NONE}},
    {'V',           CAPLOK, {L'v',                 L'V',               WCH_NONE, UC_SQUARE_ROOT,        UC_LOZENGE}},
    {'B',           CAPLOK, {L'b',                 L'B',               WCH_NONE, UC_INTEGRAL,           WCH_NONE}},
    {'N',           CAPLOK, {L'n',                 L'N',               WCH_NONE, WCH_DEAD,              UC_DOT_ABOVE}},
    {VK__none_,     0x00,   {WCH_NONE,             WCH_NONE,           WCH_NONE, L'~',                  WCH_NONE}},
    {'M',           CAPLOK, {L'm',                 L'M',               WCH_NONE, UC_MICRO,              0x02DA}},
    {VK_OEM_COMMA,  0x00,   {L',',                 L';',               WCH_NONE, UC_DA_LEFT_QUOT,       UC_DA_RIGHT_QUOT}},
    {VK_OEM_PERIOD, 0x00,   {L'.',                 L':',               WCH_NONE, UC_ELLIPSIS,           UC_DIVISION}},
