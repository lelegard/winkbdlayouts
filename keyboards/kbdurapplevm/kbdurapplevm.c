...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'W',           SGCAPS, {L'w',     L'W',     WCH_NONE, 0x2211,   0x201E}},      // N-ary summation, Double low-9 quotation
    ...
    {'R',           SGCAPS, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x2030}},      // Registered, Per mille sign
    {'R',           0x00,   {L'R',     L'R',     0x0000,   0x0000,   0x0000}},
    {'T',           SGCAPS, {L't',     L'T',     WCH_NONE, 0x2020,   0x02C7}},      // Dagger, Caron
    ...
    {'P',           SGCAPS, {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},      // N-ary product
    ...
    {'D',           SGCAPS, {L'd',     L'D',     WCH_NONE, 0x2202,   0x00CE}},      // Partial differential, I circumflex
    ...
    {'J',           SGCAPS, {L'j',     L'J',     WCH_NONE, 0x2206,   0x00D4}},      // Increment, O circumflex
    {'J',           0x00,   {L'J',     L'J',     0x0000,   0x0000,   0x0000}},
    {'K',           SGCAPS, {L'k',     L'K',     WCH_NONE, 0x02DA,   0x2225}},      // Parallel to
    ...
    {'X',           SGCAPS, {L'x',     L'X',     WCH_NONE, 0x2248,   0x02DB}},      // Almost equal to, Ogonek
    ...
    {'V',           SGCAPS, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},      // Square root, Lozenge
    {'V',           0x00,   {L'V',     L'V',     0x0000,   0x0000,   0x0000}},
    {'B',           SGCAPS, {L'b',     L'B',     WCH_NONE, 0x222B,   0x0131}},      // Integral, Dotless I
