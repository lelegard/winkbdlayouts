...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'Q',           SGCAPS, {L'q',       L'Q',          WCH_NONE, UC_LOWER_OE,           UC_UPPER_OE}},
    {'Q',           0x00,   {L'Q',       L'Q',          0x0000,   0x0000,                0x0000}},
    {'W',           SGCAPS, {L'w',       L'W',          WCH_NONE, UC_N_ARY_SUM,          UC_D9_QUOT}},
    {'W',           0x00,   {L'W',       L'W',          0x0000,   0x0000,                0x0000}},
    {'E',           SGCAPS, {L'e',       L'E',          WCH_NONE, WCH_DEAD,              UC_ACUTE}},
    {VK__none_,     0x00,   {L'E',       L'E',          WCH_NONE, UC_ACUTE,              WCH_NONE}},
    {'R',           SGCAPS, {L'r',       L'R',          WCH_NONE, UC_REGISTERED,         UC_PER_MILLE}},
    {'R',           0x00,   {L'R',       L'R',          0x0000,   0x0000,                0x0000}},
    {'T',           SGCAPS, {L't',       L'T',          WCH_NONE, UC_DAGGER,             UC_CARON}},
    {'T',           0x00,   {L'T',       L'T',          0x0000,   0x0000,                0x0000}},
    {'Y',           SGCAPS, {L'y',       L'Y',          WCH_NONE, UC_YEN,                UC_UPPER_A_ACUTE}},
    {'Y',           0x00,   {L'Y',       L'Y',          0x0000,   0x0000,                0x0000}},
    {'U',           SGCAPS, {L'u',       L'U',          WCH_NONE, WCH_DEAD,              UC_DIAERESIS}},
    {VK__none_,     0x00,   {L'U',       L'U',          WCH_NONE, UC_DIAERESIS,          WCH_NONE}},
    {'I',           SGCAPS, {L'i',       L'I',          WCH_NONE, WCH_DEAD,              UC_MODIFIER_CIRCUMFLEX}},
    {VK__none_,     0x00,   {L'I',       L'I',          WCH_NONE, L'^',                  WCH_NONE}},
    {'O',           SGCAPS, {L'o',       L'O',          WCH_NONE, UC_LOWER_O_STROKE,     UC_UPPER_O_STROKE}},
    {'O',           0x00,   {L'O',       L'O',          0x0000,   0x0000,                0x0000}},
    {'P',           SGCAPS, {L'p',       L'P',          WCH_NONE, UC_LOWER_PI,           UC_N_ARY_PROD}},
    ...
    {'A',           SGCAPS, {L'a',       L'A',          WCH_NONE, UC_LOWER_A_RING_ABOVE, UC_UPPER_A_RING_ABOVE}},
    {'A',           0x00,   {L'A',       L'A',          0x0000,   0x0000,                0x0000}},
    {'S',           SGCAPS, {L's',       L'S',          WCH_NONE, UC_LOWER_SHARP_S,      UC_UPPER_I_ACUTE}},
    {'S',           0x00,   {L'S',       L'S',          0x0000,   0x0000,                0x0000}},
    {'D',           SGCAPS, {L'd',       L'D',          WCH_NONE, UC_PARTIAL_DIFF,       UC_UPPER_I_CIRCUMFLEX}},
    {'D',           0x00,   {L'D',       L'D',          0x0000,   0x0000,                0x0000}},
    {'F',           SGCAPS, {L'f',       L'F',          WCH_NONE, UC_LATIN_SMALL_F_HOOK, UC_UPPER_I_DIAERESIS}},
    {'F',           0x00,   {L'F',       L'F',          0x0000,   0x0000,                0x0000}},
    {'G',           SGCAPS, {L'g',       L'G',          WCH_NONE, UC_COPYRIGHT,          UC_DOUBLE_ACUTE}},
    {'G',           0x00,   {L'G',       L'G',          0x0000,   0x0000,                0x0000}},
    {'H',           SGCAPS, {L'h',       L'H',          WCH_NONE, UC_DOT_ABOVE,          UC_UPPER_O_ACUTE}},
    {'H',           0x00,   {L'H',       L'H',          0x0000,   0x0000,                0x0000}},
    {'J',           SGCAPS, {L'j',       L'J',          WCH_NONE, 0x2206,                UC_UPPER_O_CIRCUMFLEX}},
    {'J',           0x00,   {L'J',       L'J',          0x0000,   0x0000,                0x0000}},
    {'K',           SGCAPS, {L'k',       L'K',          WCH_NONE, 0x02DA,                0x2225}},
    {'K',           0x00,   {L'K',       L'K',          0x0000,   0x0000,                0x0000}},
    {'L',           SGCAPS, {L'l',       L'L',          WCH_NONE, UC_NOT,                UC_UPPER_O_GRAVE}},
    ...
    {'Z',           SGCAPS, {L'z',       L'Z',          WCH_NONE, UC_UPPER_OMEGA,        UC_CEDILLA}},
    {'Z',           0x00,   {L'Z',       L'Z',          0x0000,   0x0000,                0x0000}},
    {'X',           SGCAPS, {L'x',       L'X',          WCH_NONE, UC_ALMOST_EQUAL,       UC_OGONEK}},
    {'X',           0x00,   {L'X',       L'X',          0x0000,   0x0000,                0x0000}},
    {'C',           SGCAPS, {L'c',       L'C',          WCH_NONE, UC_LOWER_C_CEDILLA,    UC_UPPER_C_CEDILLA}},
    {'C',           0x00,   {L'C',       L'C',          0x0000,   0x0000,                0x0000}},
    {'V',           SGCAPS, {L'v',       L'V',          WCH_NONE, UC_SQUARE_ROOT,        UC_LOZENGE}},
    {'V',           0x00,   {L'V',       L'V',          0x0000,   0x0000,                0x0000}},
    {'B',           SGCAPS, {L'b',       L'B',          WCH_NONE, UC_INTEGRAL,           UC_LOWER_DOTLESS_I}},
    {'B',           0x00,   {L'B',       L'B',          0x0000,   0x0000,                0x0000}},
    {'N',           SGCAPS, {L'n',       L'N',          WCH_NONE, WCH_DEAD,              UC_SMALL_TILDE}},
    {VK__none_,     0x00,   {L'N',       L'N',          WCH_NONE, L'~',                  WCH_NONE}},
    {'M',           SGCAPS, {L'm',       L'M',          WCH_NONE, UC_MICRO,              UC_UPPER_A_CIRCUMFLEX}},
