...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 =====     ====      ========  ==============
    {'1',           0x00,   {L'1',     L'!',     WCH_NONE, 0x00A1,   0x2248}},      // Inv !
    ...
    {'5',           0x00,   {L'5',     L'%',     WCH_NONE, 0x221E,   0x2225}},
    {'6',           0x00,   {L'6',     L'?',     WCH_NONE, WCH_NONE, 0x2020}},
    {'7',           0x00,   {L'7',     L'&',     WCH_NONE, L'{',     0x2021}},
    {'8',           0x00,   {L'8',     L'*',     WCH_NONE, L'}',     0x2022}},
    {'9',           0x00,   {L'9',     L'(',     WCH_NONE, L'[',     0x00B1}},      // +/-
    {'0',           0x00,   {L'0',     L')',     WCH_NONE, L']',     0x2014}},
    {VK_OEM_MINUS,  0x00,   {L'-',     L'_',     WCH_NONE, L'|',     0x00BF}},      // Inv ?
    {VK_OEM_PLUS,   0x00,   {L'=',     L'+',     WCH_NONE, 0x00AC,   0x2013}},      // Not
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x0153,   0x0152}},      // oe, OE
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2211,   0x2030}},
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x2202,   0x00AF}},      // Macron
    ...
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, 0x03C0,   0x220F}},
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},      // o stroke, O stroke
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x201C,   0x201D}},
    {VK_OEM_4,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, WCH_DEAD, 0x201E}},
    ...
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0xFB02}},      // f HOOK
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x00A9,   0xFB01}},      // Copyright
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x02D9,   0x00B7}},      // Dot above, Middle dot
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x2206,   0x201A}},
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x02DA,   0x2044}},
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, WCH_NONE, 0x2026}},
    {VK_OEM_1,      0x00,   {L';',     L':',     WCH_NONE, 0x00B0,   WCH_DEAD}},    // Degree
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, 0x00B4}},      // Acute
    {VK_OEM_3,      CAPLOK, {0x00E8,   0x00C8,   WCH_NONE, L'\\',    0x2019}},      // e grave, E grave
    {VK_OEM_7,      0x00,   {L'/',     L'\\',    WCH_NONE, L'|',     WCH_NONE}},
    {VK_OEM_5,      CAPLOK, {0x00E0,   0x00C0,   WCH_NONE, L'`',     WCH_DEAD}},    // a grave, A grave
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, L'`'}},
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x00AB,   0x2039}},      // <<
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x00BB,   0x203A}},      // >>
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A2,   0x2020}},      // Cent
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x2264}},
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_NONE, 0x2265}},
    ...
    {VK_OEM_2,      CAPLOK, {0x00E9,   0x00C9,   WCH_NONE, L'/',     0x2260}},      // e acute, E acute
