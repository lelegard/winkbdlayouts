...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'3',           0x00,   {L'3',       UC_POUND,      WCH_NONE, L'#',                  UC_SA_LEFT_QUOT}},
    ...
    {VK_OEM_8,      0x00,   {UC_SECTION, UC_PLUS_MINUS, WCH_NONE, WCH_NONE,              WCH_NONE}},
    ...
    {VK_OEM_5,      0x00,   {L'`',       L'~',          WCH_NONE, WCH_DEAD,              UC_UPPER_Y_DIAERESIS}},
    {VK__none_,     0x00,   {WCH_NONE,   WCH_NONE,      WCH_NONE, L'`',                  WCH_NONE}},
