//---------------------------------------------------------------------------
// Belgian (period) Apple VM Keyboard Layout (WKL)
// Automatically generated from kbdprlbe.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                           -----         ----      -----                  -----------
    {'1',           0x00,   {L'&',               L'1',         WCH_NONE, 0x2225,                WCH_DEAD}},
    {VK__none_,     0x00,   {WCH_NONE,           WCH_NONE,     WCH_NONE, WCH_NONE,              UC_ACUTE}},
    {'2',           0x00,   {UC_LOWER_E_ACUTE,   L'2',         WCH_NONE, UC_LOWER_E_DIAERESIS,  UC_D9_QUOT}},
    {'3',           0x00,   {L'"',               L'3',         WCH_NONE, UC_D_LEFT_QUOT,        UC_D_RIGHT_QUOT}},
    {'4',           0x00,   {L'\'',              L'4',         WCH_NONE, UC_S_LEFT_QUOT,        UC_S_RIGHT_QUOT}},
    {'5',           0x00,   {L'(',               L'5',         WCH_NONE, L'{',                  L'['}},
    {'6',           0x00,   {UC_SECTION,         L'6',         WCH_NONE, UC_PILCROW,            UC_LOWER_A_RING_ABOVE}},
    {'7',           0x00,   {UC_LOWER_E_GRAVE,   L'7',         WCH_NONE, UC_DA_LEFT_QUOT,       UC_DA_RIGHT_QUOT}},
    {'8',           0x00,   {L'!',               L'8',         WCH_NONE, UC_INV_EXCL,           UC_UPPER_U_CIRCUMFLEX}},
    {'9',           0x00,   {UC_LOWER_C_CEDILLA, L'9',         WCH_NONE, UC_UPPER_C_CEDILLA,    UC_UPPER_A_ACUTE}},
    {'0',           0x00,   {UC_LOWER_A_GRAVE,   L'0',         WCH_NONE, UC_LOWER_O_STROKE,     UC_UPPER_O_STROKE}},
    {VK_OEM_4,      0x00,   {L')',               UC_DEGREE,    WCH_NONE, L'}',                  L']'}},
    {VK_OEM_MINUS,  0x00,   {L'-',               L'_',         WCH_NONE, UC_EM_DASH,            UC_EN_DASH}},
    {'A',           CAPLOK, {L'a',               L'A',         WCH_NONE, UC_LOWER_AE,           UC_UPPER_AE}},
    {'Z',           CAPLOK, {L'z',               L'Z',         WCH_NONE, UC_UPPER_A_CIRCUMFLEX, UC_UPPER_A_RING_ABOVE}},
    {'E',           CAPLOK, {L'e',               L'E',         WCH_NONE, UC_LOWER_E_CIRCUMFLEX, UC_UPPER_E_CIRCUMFLEX}},
    {'R',           CAPLOK, {L'r',               L'R',         WCH_NONE, UC_REGISTERED,         UC_S9_QUOT}},
    {'T',           CAPLOK, {L't',               L'T',         WCH_NONE, UC_DAGGER,             UC_TRADE}},
    {'Y',           CAPLOK, {L'y',               L'Y',         WCH_NONE, UC_UPPER_U_ACUTE,      UC_UPPER_Y_DIAERESIS}},
    {'U',           CAPLOK, {L'u',               L'U',         WCH_NONE, UC_MORDINAL,           UC_FORDINAL}},
    {'I',           CAPLOK, {L'i',               L'I',         WCH_NONE, UC_LOWER_I_CIRCUMFLEX, UC_LOWER_I_DIAERESIS}},
    {'O',           CAPLOK, {L'o',               L'O',         WCH_NONE, UC_LOWER_OE,           UC_UPPER_OE}},
    {'P',           CAPLOK, {L'p',               L'P',         WCH_NONE, UC_LOWER_PI,           UC_N_ARY_PROD}},
    {VK_OEM_6,      0x00,   {WCH_DEAD,           WCH_DEAD,     WCH_NONE, UC_LOWER_O_CIRCUMFLEX, UC_UPPER_O_CIRCUMFLEX}},
    {VK__none_,     0x00,   {L'^',               UC_DIAERESIS, WCH_NONE, WCH_NONE,              WCH_NONE}},
    {VK_OEM_1,      0x00,   {L'$',               L'*',         WCH_NONE, UC_EURO,               UC_YEN}},
    {'Q',           CAPLOK, {L'q',               L'Q',         WCH_NONE, UC_D_DAGGER,           UC_UPPER_OMEGA}},
    {'S',           CAPLOK, {L's',               L'S',         WCH_NONE, UC_UPPER_O_GRAVE,      UC_N_ARY_SUM}},
    {'D',           CAPLOK, {L'd',               L'D',         WCH_NONE, UC_PARTIAL_DIFF,       0x2206}},
    {'F',           CAPLOK, {L'f',               L'F',         WCH_NONE, UC_LATIN_SMALL_F_HOOK, UC_MIDDOT}},
    {'G',           CAPLOK, {L'g',               L'G',         WCH_NONE, UC_LOWER_FI,           UC_LOWER_FL}},
    {'H',           CAPLOK, {L'h',               L'H',         WCH_NONE, UC_UPPER_I_GRAVE,      UC_UPPER_I_CIRCUMFLEX}},
    {'J',           CAPLOK, {L'j',               L'J',         WCH_NONE, UC_UPPER_I_DIAERESIS,  UC_UPPER_I_ACUTE}},
    {'K',           CAPLOK, {L'k',               L'K',         WCH_NONE, UC_UPPER_E_GRAVE,      UC_UPPER_E_DIAERESIS}},
    {'L',           CAPLOK, {L'l',               L'L',         WCH_NONE, UC_NOT,                L'|'}},
    {'M',           CAPLOK, {L'm',               L'M',         WCH_NONE, UC_MICRO,              UC_UPPER_O_ACUTE}},
    {VK_OEM_3,      0x00,   {UC_LOWER_U_GRAVE,   L'%',         WCH_NONE, UC_UPPER_U_GRAVE,      UC_PER_MILLE}},
    {VK_OEM_7,      0x00,   {L'@',               L'#',         WCH_NONE, UC_BULLET,             UC_UPPER_Y_DIAERESIS}},
    {VK_OEM_5,      0x00,   {WCH_DEAD,           UC_POUND,     WCH_NONE, L'@',                  L'#'}},
    {VK__none_,     0x00,   {L'`',               WCH_NONE,     WCH_NONE, WCH_NONE,              WCH_NONE}},
    {'W',           CAPLOK, {L'w',               L'W',         WCH_NONE, UC_SA_LEFT_QUOT,       UC_SA_RIGHT_QUOT}},
    {'X',           CAPLOK, {L'x',               L'X',         WCH_NONE, UC_ALMOST_EQUAL,       UC_FRACTION_SLASH}},
    {'C',           CAPLOK, {L'c',               L'C',         WCH_NONE, UC_COPYRIGHT,          UC_CENT}},
    {'V',           CAPLOK, {L'v',               L'V',         WCH_NONE, UC_LOZENGE,            UC_SQUARE_ROOT}},
    {'B',           CAPLOK, {L'b',               L'B',         WCH_NONE, UC_LOWER_SHARP_S,      UC_INTEGRAL}},
    {'N',           CAPLOK, {L'n',               L'N',         WCH_NONE, WCH_DEAD,              UC_LOWER_DOTLESS_I}},
    {VK__none_,     0x00,   {WCH_NONE,           WCH_NONE,     WCH_NONE, L'~',                  WCH_NONE}},
    {VK_OEM_COMMA,  0x00,   {L',',               L'?',         WCH_NONE, UC_INFINITY,           UC_INV_QUESTION}},
    {VK_OEM_PERIOD, 0x00,   {L';',               L'.',         WCH_NONE, UC_ELLIPSIS,           UC_BULLET}},
    {VK_OEM_2,      0x00,   {L':',               L'/',         WCH_NONE, UC_DIVISION,           L'\\'}},
