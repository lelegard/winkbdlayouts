...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 -----     ----      --------  --------------
    {'1',           0x00,   {L'&',     L'1',     WCH_NONE, 0x2225,   WCH_DEAD}},    // Parallel to
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE, 0x00B4}},      // Acute
    {'2',           0x00,   {0x00E9,   L'2',     WCH_NONE, 0x00EB,   0x201E}},      // e acute, e diaeresis, Double low-9 quotation
    {'3',           0x00,   {L'"',     L'3',     WCH_NONE, 0x201C,   0x201D}},      // Left double quotation, Right double quotation
    {'4',           0x00,   {L'\'',    L'4',     WCH_NONE, 0x2018,   0x2019}},      // Left single quotation, Right single quotation
    {'5',           0x00,   {L'(',     L'5',     WCH_NONE, L'{',     L'['}},
    {'6',           0x00,   {0x00A7,   L'6',     WCH_NONE, 0x00B6,   0x00E5}},      // Section, Pilcrow, a ring above
    {'7',           0x00,   {0x00E8,   L'7',     WCH_NONE, 0x00AB,   0x00BB}},      // e grave, <<, >>
    {'8',           0x00,   {L'!',     L'8',     WCH_NONE, 0x00A1,   0x00DB}},      // Inv !, U circumflex
    {'9',           0x00,   {0x00E7,   L'9',     WCH_NONE, 0x00C7,   0x00C1}},      // c cedilla, C cedilla, A acute
    {'0',           0x00,   {0x00E0,   L'0',     WCH_NONE, 0x00F8,   0x00D8}},      // a grave, o stroke, O stroke
    {VK_OEM_4,      0x00,   {L')',     0x00B0,   WCH_NONE, L'}',     L']'}},        // Degree
    {VK_OEM_MINUS,  0x00,   {L'-',     L'_',     WCH_NONE, 0x2014,   0x2013}},      // Em dash, En dash
    ...
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2020,   0x2122}},      // Dagger
    ...
    {VK_OEM_6,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, 0x00F4,   0x00D4}},      // o circumflex, O circumflex
    {VK__none_,     0x00,   {L'^',     0x00A8,   WCH_NONE, WCH_NONE, WCH_NONE}},    // Diaeresis
    {VK_OEM_1,      0x00,   {L'$',     L'*',     WCH_NONE, 0x20AC,   0x00A5}},      // Yen
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x2021,   0x03A9}},      // Double dagger
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x00D2,   0x2211}},      // O grave, N-ary summation
    ...
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0xFB01,   0xFB02}},      // Ligature fi, Ligature fl
    ...
    {VK_OEM_3,      0x00,   {0x00F9,   L'%',     WCH_NONE, 0x00D9,   0x2030}},      // u grave, U grave, Per mille sign
    {VK_OEM_7,      0x00,   {L'@',     L'#',     WCH_NONE, 0x2022,   0x0178}},      // Bullet, Y diaeresis
    {VK_OEM_5,      0x00,   {WCH_DEAD, 0x00A3,   WCH_NONE, L'@',     L'#'}},        // Pound
    {VK__none_,     0x00,   {L'`',     WCH_NONE, WCH_NONE, WCH_NONE, WCH_NONE}},
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2039,   0x203A}},      // Single left-pointing angle quotation, Single right-pointing angle quotation
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2248,   0x2044}},      // Almost equal to, Fraction slash
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A9,   0x00A2}},      // Copyright, Cent
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x25CA,   0x221A}},      // Lozenge, Square root
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x00DF,   0x222B}},      // sharp S, Integral
    ...
    {VK_OEM_PERIOD, 0x00,   {L';',     L'.',     WCH_NONE, 0x2026,   0x2022}},      // Horizontal ellipsis, Bullet
