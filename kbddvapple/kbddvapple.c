//---------------------------------------------------------------------------
// United States (Dvorak) Apple Keyboard Layout (WKL)
// Automatically generated from kbdprldv.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {VK_OEM_7,      CAPLOKALTGR, {L'\'',    L'"',     WCH_NONE, 0x00E6,   0x00C6}},
    ...
    {VK_OEM_3,      CAPLOKALTGR, {L'`',     L'~',     WCH_NONE, WCH_DEAD, L'`'}},
    {VK__none_,     0x00,        {WCH_NONE, WCH_NONE, WCH_NONE, L'`',     WCH_NONE}},
    ...
    {VK_SPACE,      0x00,        {L' ',     L' ',     WCH_NONE, 0x00A0,   WCH_NONE}},
    {VK_OEM_102,    0x00,        {0x00A7,   0x00B1,   WCH_NONE, 0x00A7,   0x00B1}},
