...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'3',           0x00,   {L'3',     0x00A3,   WCH_NONE, 0x2018,   0x2019}},
    {'4',           0x00,   {L'4',     L'$',     WCH_NONE, 0x00A5,   0x00A2}},
    ...
    {VK_OEM_4,      0x00,   {L'\'',    L'?',     WCH_NONE, 0x00A1,   0x00BF}},
    {VK_OEM_6,      0x00,   {0x00EC,   L'^',     WCH_NONE, WCH_DEAD, 0x00B1}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'^',     WCH_NONE}},
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x201E,   0x201A}},
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x03A9,   0x00C0}},
    {'E',           CAPLOK, {L'e',     L'E',     WCH_NONE, 0x20AC,   0x00C8}},
    {'R',           CAPLOK, {L'r',     L'R',     WCH_NONE, 0x00AE,   0x00CC}},
    {'T',           CAPLOK, {L't',     L'T',     WCH_NONE, 0x2122,   0x00D2}},
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00E6,   0x00C6}},
    {'U',           CAPLOK, {L'u',     L'U',     WCH_NONE, WCH_DEAD, 0x00D9}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, 0x00A8,   WCH_NONE}},
    {'I',           CAPLOK, {L'i',     L'I',     WCH_NONE, 0x0153,   0x0152}},
    {'O',           CAPLOK, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},
    {'P',           CAPLOK, {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},
    {VK_OEM_1,      0x00,   {0x00E8,   0x00E9,   WCH_NONE, L'[',     L'{'}},
    {VK_OEM_PLUS,   0x00,   {L'+',     L'*',     WCH_NONE, L']',     L'}'}},
    {'A',           CAPLOK, {L'a',     L'A',     WCH_NONE, 0x00E5,   0x00C5}},
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x00DF,   0x00AF}},
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0x02D8}},
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0x02D9}},
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x221E,   0x02DA}},
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x2206,   0x00B8}},
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x00AA,   0x02DD}},
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x00BA,   0x02DB}},
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, 0x00AC,   0x02C7}},
    {VK_OEM_3,      0x00,   {0x00F2,   0x00E7,   WCH_NONE, L'@',     0x00C7}},
    {VK_OEM_7,      0x00,   {0x00E0,   0x00B0,   WCH_NONE, L'#',     0x221E}},
    {VK_OEM_5,      0x00,   {L'\\',    L'|',     WCH_NONE, L'`',     0x0131}},
    {VK_OEM_2,      0x00,   {0x00F9,   0x00A7,   WCH_NONE, 0x00B6,   0x25CA}},
    {'Z',           CAPLOK, {L'z',     L'Z',     WCH_NONE, 0x2211,   WCH_NONE}},
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2020,   0x2021}},
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A9,   0x00C1}},
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x00C9}},
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   0x00CD}},
    {'N',           CAPLOK, {L'n',     L'N',     WCH_NONE, WCH_DEAD, 0x00D3}},
    {VK__none_,     0x00,   {WCH_NONE, WCH_NONE, WCH_NONE, L'~',     WCH_NONE}},
    {'M',           CAPLOK, {L'm',     L'M',     WCH_NONE, 0x00B5,   0x00DA}},
    {VK_OEM_COMMA,  0x00,   {L',',     L';',     WCH_NONE, 0x2026,   WCH_NONE}},
    {VK_OEM_PERIOD, 0x00,   {L'.',     L':',     WCH_NONE, 0x2022,   0x00B7}},
