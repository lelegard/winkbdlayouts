...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    //                                 =====     ====      ========  ==============
    {'1',           CAPLOK, {L'1',     L'+',     WCH_NONE, 0x00B1,   0x221E}},      // +/-
    {'2',           CAPLOK, {L'2',     L'"',     WCH_NONE, 0x201C,   0x201D}},
    {'3',           CAPLOK, {L'3',     L'*',     WCH_NONE, L'#',     0x2039}},
    {'4',           CAPLOK, {L'4',     0x00E7,   WCH_NONE, 0x00C7,   0x2044}},      // c cedilla, C cedilla
    ...
    {'0',           CAPLOK, {L'0',     L'=',     WCH_NONE, 0x2260,   0x00DA}},      // U acute
    {VK_OEM_4,      0x00,   {L'\'',    L'?',     WCH_NONE, 0x00BF,   0x2225}},      // Inv ?
    ...
    {VK_OEM_3,      0x00,   {WCH_DEAD, L'!',     WCH_NONE, 0x2018,   0x2019}},
    ...
    {'S',           CAPLOK, {L's',     L'S',     WCH_NONE, 0x00DF,   0xFB01}},      // sharp S
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0xFB02}},
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0x2021}},      // f HOOK
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, L'@',     0x201A}},
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x00AA,   0x00B7}},      // Fem ord, Middle dot
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x00BA,   0x02DC}},      // Masc ord, Small tilde
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x2206,   0x00AF}},      // Macron
    ...
    {VK_OEM_2,      0x00,   {0x00A7,   0x00B0,   WCH_NONE, 0xFB01,   0x2030}},      // Section, Degree
    {VK_OEM_8,      0x00,   {L'$',     0x00A3,   WCH_NONE, 0x00B6,   0x2022}},      // Pound, Pilcrow
    {'Y',           CAPLOK, {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x0178}},      // Yen, Y diaeresis
    {'X',           CAPLOK, {L'x',     L'X',     WCH_NONE, 0x2248,   0x2122}},
    {'C',           CAPLOK, {L'c',     L'C',     WCH_NONE, 0x00A9,   WCH_NONE}},    // Copyright
    {'V',           CAPLOK, {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},
    {'B',           CAPLOK, {L'b',     L'B',     WCH_NONE, 0x222B,   WCH_NONE}},
    ...
    {VK_OEM_PERIOD, 0x00,   {L'.',     L':',     WCH_NONE, 0x2026,   0x00F7}},      // Division
