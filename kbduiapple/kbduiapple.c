...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'6',           0x00,                 {L'6',     WCH_DEAD, WCH_NONE, 0x00A7,   0xFB02}},
    ...
    {'Q',           CAPLOK | CAPLOKALTGR, {L'q',     L'Q',     WCH_NONE, 0x0153,   0x0152}},
    {'W',           CAPLOK,               {L'w',     L'W',     WCH_NONE, 0x2211,   0x201E}},
    {'E',           CAPLOK,               {L'e',     L'E',     WCH_NONE, WCH_DEAD, 0x00B4}},
    {VK__none_,     0x00,                 {WCH_NONE, WCH_NONE, WCH_NONE, 0x00B4,   WCH_NONE}},
    {'R',           CAPLOK,               {L'r',     L'R',     WCH_NONE, 0x00AE,   0x2030}},
    {'T',           CAPLOK,               {L't',     L'T',     WCH_NONE, 0x2020,   0x02C7}},
    {'Y',           CAPLOK,               {L'y',     L'Y',     WCH_NONE, 0x00A5,   0x00C1}},
    {'U',           CAPLOK,               {L'u',     L'U',     WCH_NONE, WCH_DEAD, 0x00A8}},
    {VK__none_,     0x00,                 {WCH_NONE, WCH_NONE, WCH_NONE, 0x00A8,   WCH_NONE}},
    {'I',           CAPLOK,               {L'i',     L'I',     WCH_NONE, WCH_DEAD, 0x02C6}},
    {VK__none_,     0x00,                 {WCH_NONE, WCH_NONE, WCH_NONE, 0x02C6,   WCH_NONE}},
    {'O',           CAPLOK | CAPLOKALTGR, {L'o',     L'O',     WCH_NONE, 0x00F8,   0x00D8}},
    {'P',           CAPLOK,               {L'p',     L'P',     WCH_NONE, 0x03C0,   0x220F}},
    {VK_OEM_4,      0x00,                 {L'[',     L'{',     WCH_NONE, 0x201C,   0x201D}},
    {VK_OEM_6,      0x00,                 {L']',     L'}',     WCH_NONE, 0x2018,   0x2019}},
    {'A',           CAPLOK | CAPLOKALTGR, {L'a',     L'A',     WCH_NONE, 0x00E5,   0x00C5}},
    {'S',           CAPLOK,               {L's',     L'S',     WCH_NONE, 0x00DF,   0x00CD}},
    {'D',           CAPLOK,               {L'd',     L'D',     WCH_NONE, 0x2202,   0x00CE}},
    {'F',           CAPLOK,               {L'f',     L'F',     WCH_NONE, 0x0192,   0x00CF}},
    {'G',           CAPLOK,               {L'g',     L'G',     WCH_NONE, 0x00A9,   0x02DD}},
    {'H',           CAPLOK,               {L'h',     L'H',     WCH_NONE, 0x02D9,   0x00D3}},
    {'J',           CAPLOK,               {L'j',     L'J',     WCH_NONE, 0x2206,   0x00D4}},
    {'K',           CAPLOK,               {L'k',     L'K',     WCH_NONE, 0x02DA,   WCH_NONE}},
    {'L',           CAPLOK,               {L'l',     L'L',     WCH_NONE, 0x00AC,   0x00D2}},
    {VK_OEM_1,      0x00,                 {L';',     L':',     WCH_NONE, 0x2026,   0x00DA}},
    {VK_OEM_7,      CAPLOKALTGR,          {WCH_DEAD, WCH_DEAD, WCH_NONE, 0x00E6,   0x00C6}},
    ...
    {'Z',           CAPLOK,               {L'z',     L'Z',     WCH_NONE, 0x03A9,   0x00B8}},
    {'X',           CAPLOK,               {L'x',     L'X',     WCH_NONE, 0x2248,   0x02DB}},
    {'C',           CAPLOK | CAPLOKALTGR, {L'c',     L'C',     WCH_NONE, 0x00E7,   0x00C7}},
    {'V',           CAPLOK,               {L'v',     L'V',     WCH_NONE, 0x221A,   0x25CA}},
    {'B',           CAPLOK,               {L'b',     L'B',     WCH_NONE, 0x222B,   0x0131}},
    {'N',           CAPLOK,               {L'n',     L'N',     WCH_NONE, WCH_DEAD, 0x02DC}},
    {VK__none_,     0x00,                 {WCH_NONE, WCH_NONE, WCH_NONE, 0x02DC,   WCH_NONE}},
    {'M',           CAPLOK,               {L'm',     L'M',     WCH_NONE, 0x00B5,   0x00C2}},
...
static DEADKEY dead_keys[] = {
    ...
    DEADTRANS(L'o', 0x00A8, 0x00EF, 0x0000),
    ...
    DEADTRANS(L' ', L'\'',  L'\'',  0x0000),
    DEADTRANS(L'a', L'"',   0x00E4, 0x0000),
    DEADTRANS(L'e', L'"',   0x00EB, 0x0000),
    DEADTRANS(L'u', L'"',   0x00FC, 0x0000),
    DEADTRANS(L'i', L'"',   0x00EF, 0x0000),
    DEADTRANS(L'y', L'"',   0x00FF, 0x0000),
    DEADTRANS(L'o', L'"',   0x00F6, 0x0000),
    DEADTRANS(L'A', L'"',   0x00C4, 0x0000),
    DEADTRANS(L'E', L'"',   0x00CB, 0x0000),
    DEADTRANS(L'U', L'"',   0x00DC, 0x0000),
    DEADTRANS(L'I', L'"',   0x00CF, 0x0000),
    DEADTRANS(L'O', L'"',   0x00D6, 0x0000),
    DEADTRANS(L' ', L'"',   L'"',   0x0000),
    DEADTRANS(L'n', 0x02DC, 0x00F1, 0x0000),
    DEADTRANS(L'a', 0x02DC, 0x00E3, 0x0000),
    DEADTRANS(L'o', 0x02DC, 0x00D1, 0x0000),
