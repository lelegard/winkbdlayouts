...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {VK_OEM_4,      0x00,   {WCH_DEAD, WCH_DEAD, WCH_NONE, L'\'',    0x2044}},
    {VK__none_,     0x00,   {0x00B4,   L'`',     WCH_NONE, WCH_NONE, WCH_NONE}},    // Acute
    {'Q',           CAPLOK, {L'q',     L'Q',     WCH_NONE, 0x00B0,   0x2022}},      // Degree
    {'W',           CAPLOK, {L'w',     L'W',     WCH_NONE, 0x2211,   0x02DA}},
    ...
    {VK_OEM_6,      CAPLOK, {0x00E5,   0x00C5,   WCH_NONE, 0x2018,   0x2019}},      // a ring above, A ring above
    ...
    {'D',           CAPLOK, {L'd',     L'D',     WCH_NONE, 0x2202,   0x02D8}},      // Breve
    {'F',           CAPLOK, {L'f',     L'F',     WCH_NONE, 0x0192,   0xFB01}},      // f HOOK
    {'G',           CAPLOK, {L'g',     L'G',     WCH_NONE, 0x00A9,   0x00C1}},      // Copyright, A acute
    {'H',           CAPLOK, {L'h',     L'H',     WCH_NONE, 0x00AB,   0x00BB}},      // <<, >>
    {'J',           CAPLOK, {L'j',     L'J',     WCH_NONE, 0x2039,   0x203A}},
    {'K',           CAPLOK, {L'k',     L'K',     WCH_NONE, 0x2206,   0x02DD}},      // Double acute
    {'L',           CAPLOK, {L'l',     L'L',     WCH_NONE, 0x00AC,   0xFB02}},      // Not
